...
type _ModelsCustomReport ModelsCustomReport
...
func (o *ModelsCustomReport) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCustomReport := _ModelsCustomReport{}

	if err = json.Unmarshal(bytes, &varModelsCustomReport); err == nil {
		*o = ModelsCustomReport(varModelsCustomReport)
	}
