...
type _ModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel ModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel
...
func (o *ModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel := _ModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel{}

	if err = json.Unmarshal(bytes, &varModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel); err == nil {
		*o = ModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel(varModelsCertificateRetrievalResponseCertificateStoreInventoryItemModel)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "StoreMachine")
		delete(additionalProperties, "StorePath")
		delete(additionalProperties, "StoreType")
		delete(additionalProperties, "Alias")
		delete(additionalProperties, "ChainLevel")
