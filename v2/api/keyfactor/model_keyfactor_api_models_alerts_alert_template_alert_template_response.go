...
type _KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse
...
func (o *KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse := _KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse); err == nil {
		*o = KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse(varKeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse)
	}
