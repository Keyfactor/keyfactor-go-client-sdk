...
// checks if the ModelsQueryModelsPagedPendingCSRQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedPendingCSRQuery{}
...
type _ModelsQueryModelsPagedPendingCSRQuery ModelsQueryModelsPagedPendingCSRQuery
...
func NewModelsQueryModelsPagedPendingCSRQuery() *ModelsQueryModelsPagedPendingCSRQuery {
	this := ModelsQueryModelsPagedPendingCSRQuery{}
	return &this
}
...
func (o *ModelsQueryModelsPagedPendingCSRQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedPendingCSRQuery := _ModelsQueryModelsPagedPendingCSRQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedPendingCSRQuery); err == nil {
		*o = ModelsQueryModelsPagedPendingCSRQuery(varModelsQueryModelsPagedPendingCSRQuery)
	}
...
type NullableModelsQueryModelsPagedPendingCSRQuery struct {
	value *ModelsQueryModelsPagedPendingCSRQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedPendingCSRQuery) Get() *ModelsQueryModelsPagedPendingCSRQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedPendingCSRQuery) Set(val *ModelsQueryModelsPagedPendingCSRQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedPendingCSRQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedPendingCSRQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedPendingCSRQuery(val *ModelsQueryModelsPagedPendingCSRQuery) *NullableModelsQueryModelsPagedPendingCSRQuery {
	return &NullableModelsQueryModelsPagedPendingCSRQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedPendingCSRQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedPendingCSRQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
