...
type _KeyfactorApiModelsCertificatesCertificateIdentityAuditResponse KeyfactorApiModelsCertificatesCertificateIdentityAuditResponse
...
func (o *KeyfactorApiModelsCertificatesCertificateIdentityAuditResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsCertificatesCertificateIdentityAuditResponse := _KeyfactorApiModelsCertificatesCertificateIdentityAuditResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsCertificatesCertificateIdentityAuditResponse); err == nil {
		*o = KeyfactorApiModelsCertificatesCertificateIdentityAuditResponse(varKeyfactorApiModelsCertificatesCertificateIdentityAuditResponse)
	}
