...
type _KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest
...
func (o *KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest := _KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest); err == nil {
		*o = KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest(varKeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest)
	}
