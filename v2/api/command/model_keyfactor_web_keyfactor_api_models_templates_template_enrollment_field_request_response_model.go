...
// checks if the KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel{}
...
func NewKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel() *KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel {
	this := KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel struct {
	value *KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) Get() *KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) Set(val *KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel(val *KeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel {
	return &NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateEnrollmentFieldRequestResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
