...
// checks if the KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse{}

// KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse struct for KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse
type KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse struct {
...
func NewKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse() *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse {
	this := KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) SetPermissionNil() {
...
func (o KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse struct {
	value *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) Get() *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) Set(val *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse(val *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentityPermissionsPermissionRolesPairResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
