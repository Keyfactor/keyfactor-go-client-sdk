...
func Test_command_CertificateStoreApiService(t *testing.T) {
	...
	t.Run("Test CertificateStoreApiService CertificateStoreCreateCertificateStore", func(t *testing.T) {

		t.Log("CertificateStoreApi_CertificateStoreCreateCertificateStore_payload: <none>")
		resp, httpRes, err := apiClient.CertificateStoreApi.CertificateStoreCreateCertificateStore(context.Background()).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		assert.Equal(t, 200, httpRes.StatusCode)
	})
	...
	t.Run("Test CertificateStoreApiService CertificateStoreGetCertificateStore", func(t *testing.T) {

		var id interface{}

		id = os.Getenv("CertificateStoreApi_CertificateStoreGetCertificateStore_id")
		id, _ = convertParamInterface(id, "string")
		t.Logf("CertificateStoreApi_CertificateStoreGetCertificateStore_id: %v", id)

		t.Log("CertificateStoreApi_CertificateStoreGetCertificateStore_payload: <none>")
		resp, httpRes, err := apiClient.CertificateStoreApi.CertificateStoreGetCertificateStore(context.Background(), id.(string)).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		assert.Equal(t, 200, httpRes.StatusCode)
	})
	...
	t.Run("Test CertificateStoreApiService CertificateStoreQueryCertificateStores", func(t *testing.T) {

		t.Log("CertificateStoreApi_CertificateStoreQueryCertificateStores_payload: <none>")
		resp, httpRes, err := apiClient.CertificateStoreApi.CertificateStoreQueryCertificateStores(context.Background()).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		assert.Equal(t, 200, httpRes.StatusCode)
	})
	...
	t.Run("Test CertificateStoreApiService CertificateStoreUpdateCertStore", func(t *testing.T) {

		t.Log("CertificateStoreApi_CertificateStoreUpdateCertStore_payload: <none>")
		resp, httpRes, err := apiClient.CertificateStoreApi.CertificateStoreUpdateCertStore(context.Background()).Execute()
		require.Nil(t, err)
		require.NotNil(t, resp)
		assert.Equal(t, 200, httpRes.StatusCode)
	})
