...
// checks if the KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest{}

// KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest struct for KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest
type KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest struct {
...
func NewKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest(displayName string, subject string, message string, rotationWarningDays int32) *KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest {
	this := KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest{}
...
func (o KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest struct {
	value *KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) Get() *KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) Set(val *KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest(val *KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) *NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest {
	return &NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
