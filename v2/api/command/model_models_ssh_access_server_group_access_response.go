...
type _ModelsSSHAccessServerGroupAccessResponse ModelsSSHAccessServerGroupAccessResponse
...
func (o *ModelsSSHAccessServerGroupAccessResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHAccessServerGroupAccessResponse := _ModelsSSHAccessServerGroupAccessResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHAccessServerGroupAccessResponse); err == nil {
		*o = ModelsSSHAccessServerGroupAccessResponse(varModelsSSHAccessServerGroupAccessResponse)
	}
