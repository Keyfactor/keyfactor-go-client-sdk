...
// checks if the CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel{}

// CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel struct for CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel
type CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel struct {
...
func NewCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel() *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel {
	this := CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel{}
	return &this
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) SetValueHashNil() {
	o.ValueHash.Set(nil)
}
...
func (o CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel struct {
	value *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel
	isSet bool
}

func (v NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) Get() *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) Set(val *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel(val *CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) *NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel {
	return &NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
