...
// checks if the CSSCMSDataModelModelsReportParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsReportParameters{}
...
func NewCSSCMSDataModelModelsReportParameters() *CSSCMSDataModelModelsReportParameters {
	this := CSSCMSDataModelModelsReportParameters{}
	return &this
}
...
func (o *CSSCMSDataModelModelsReportParameters) GetParameterType() CSSCMSCoreEnumsReportParameterType {
	if o == nil || isNil(o.ParameterType) {
		var ret CSSCMSCoreEnumsReportParameterType
		return ret
	}
...
func (o *CSSCMSDataModelModelsReportParameters) GetParameterVisibility() CSSCMSCoreEnumsReportParameterVisibility {
	if o == nil || isNil(o.ParameterVisibility) {
		var ret CSSCMSCoreEnumsReportParameterVisibility
		return ret
	}
...
type NullableCSSCMSDataModelModelsReportParameters struct {
	value *CSSCMSDataModelModelsReportParameters
	isSet bool
}

func (v NullableCSSCMSDataModelModelsReportParameters) Get() *CSSCMSDataModelModelsReportParameters {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsReportParameters) Set(val *CSSCMSDataModelModelsReportParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsReportParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsReportParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsReportParameters(val *CSSCMSDataModelModelsReportParameters) *NullableCSSCMSDataModelModelsReportParameters {
	return &NullableCSSCMSDataModelModelsReportParameters{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsReportParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsReportParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
