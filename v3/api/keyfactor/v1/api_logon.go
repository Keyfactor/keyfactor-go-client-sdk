...
*/
func (a *LogonApiService) CreateSSHLogons(ctx context.Context) ApiCreateSSHLogonsRequest {
...
*/
func (a *LogonApiService) CreateSSHLogonsAccess(ctx context.Context) ApiCreateSSHLogonsAccessRequest {
...
*/
func (a *LogonApiService) DeleteSSHLogonsById(ctx context.Context, id int32) ApiDeleteSSHLogonsByIdRequest {
...
*/
func (a *LogonApiService) GetSSHLogons(ctx context.Context) ApiGetSSHLogonsRequest {
...
*/
func (a *LogonApiService) GetSSHLogonsById(ctx context.Context, id int32) ApiGetSSHLogonsByIdRequest {
