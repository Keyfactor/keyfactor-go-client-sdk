...
// checks if the CSSCMSDataModelModelsSSHUsersSshUserCreationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsSSHUsersSshUserCreationRequest{}
...
func NewCSSCMSDataModelModelsSSHUsersSshUserCreationRequest(username string) *CSSCMSDataModelModelsSSHUsersSshUserCreationRequest {
	this := CSSCMSDataModelModelsSSHUsersSshUserCreationRequest{}
...
func (o CSSCMSDataModelModelsSSHUsersSshUserCreationRequest) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsSSHUsersSshUserCreationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest struct {
	value *CSSCMSDataModelModelsSSHUsersSshUserCreationRequest
	isSet bool
}

func (v NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest) Get() *CSSCMSDataModelModelsSSHUsersSshUserCreationRequest {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest) Set(val *CSSCMSDataModelModelsSSHUsersSshUserCreationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest(val *CSSCMSDataModelModelsSSHUsersSshUserCreationRequest) *NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest {
	return &NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsSSHUsersSshUserCreationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
