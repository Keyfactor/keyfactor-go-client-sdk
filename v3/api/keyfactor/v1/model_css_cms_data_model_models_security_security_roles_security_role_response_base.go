...
// checks if the CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase{}
...
func NewCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase() *CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase {
	this := CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase{}
	return &this
}
...
func (o *CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase struct {
	value *CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase
	isSet bool
}

func (v NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) Get() *CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) Set(val *CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase(val *CSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) *NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase {
	return &NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsSecuritySecurityRolesSecurityRoleResponseBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
