...
// checks if the CertificatesCertificateRetrievalResponseCRLDistributionPointModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificatesCertificateRetrievalResponseCRLDistributionPointModel{}
...
// NewCertificatesCertificateRetrievalResponseCRLDistributionPointModel instantiates a new CertificatesCertificateRetrievalResponseCRLDistributionPointModel object
...
// NewCertificatesCertificateRetrievalResponseCRLDistributionPointModelWithDefaults instantiates a new CertificatesCertificateRetrievalResponseCRLDistributionPointModel object
...
func (o *CertificatesCertificateRetrievalResponseCRLDistributionPointModel) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *CertificatesCertificateRetrievalResponseCRLDistributionPointModel) SetUrlHashNil() {
	o.UrlHash.Set(nil)
}
...
func (o CertificatesCertificateRetrievalResponseCRLDistributionPointModel) MarshalJSON() ([]byte, error) {
...
func (o CertificatesCertificateRetrievalResponseCRLDistributionPointModel) ToMap() (map[string]interface{}, error) {
...
type NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel struct {
	value *CertificatesCertificateRetrievalResponseCRLDistributionPointModel
	isSet bool
}

func (v NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel) Get() *CertificatesCertificateRetrievalResponseCRLDistributionPointModel {
	return v.value
}

func (v *NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel) Set(val *CertificatesCertificateRetrievalResponseCRLDistributionPointModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel(val *CertificatesCertificateRetrievalResponseCRLDistributionPointModel) *NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel {
	return &NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel{value: val, isSet: true}
}

func (v NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificatesCertificateRetrievalResponseCRLDistributionPointModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
