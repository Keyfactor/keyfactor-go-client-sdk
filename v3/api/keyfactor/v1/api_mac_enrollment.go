...
*/
func (a *MacEnrollmentApiService) GetMacEnrollment(ctx context.Context) ApiGetMacEnrollmentRequest {
...
*/
func (a *MacEnrollmentApiService) UpdateMacEnrollment(ctx context.Context) ApiUpdateMacEnrollmentRequest {
