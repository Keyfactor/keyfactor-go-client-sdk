...
// GetIsLocalDBOk returns a tuple with the IsLocalDB field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CSSCMSDataModelModelsProvider) GetIsLocalDBOk() (*bool, bool) {
	if o == nil || isNil(o.IsLocalDB) {
		return nil, false
	}
	return o.IsLocalDB, true
}
