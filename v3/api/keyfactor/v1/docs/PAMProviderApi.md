...
[**DeletePamProvidersTypesById**](PAMProviderApi.md#DeletePamProvidersTypesById) | **DELETE** /PamProviders/Types/{id} | Deletes a PAM provider Type, as long as the PAM type is not currently in use.
...
> PAMProviderResponseLegacy CreatePamProviders(ctx).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XKeyfactorApiVersion(xKeyfactorApiVersion).PAMProviderCreateRequest(pAMProviderCreateRequest).Execute()
...
func main() {
    ...
    // response from `CreatePamProviders`: PAMProviderResponseLegacy
...
[**PAMProviderResponseLegacy**](PAMProviderResponseLegacy.md)
...
> DeletePamProvidersTypesById(ctx, id).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XKeyfactorApiVersion(xKeyfactorApiVersion).Execute()
...
func main() {
    id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | PAM provider type Id to be used
    xKeyfactorRequestedWith := "APIClient" // string | Type of the request [XMLHttpRequest, APIClient]
    xKeyfactorApiVersion := "1.0" // string | Desired version of the api, if not provided defaults to v1 (optional)

    configuration := openapiclient.NewConfiguration(make(map[string]string))
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PAMProviderApi.DeletePamProvidersTypesById(context.Background(), id).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XKeyfactorApiVersion(xKeyfactorApiVersion).Execute()
    if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **string** | PAM provider type Id to be used | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeletePamProvidersTypesByIdRequest struct via the builder pattern
...
> []PAMProviderResponseLegacy GetPamProviders(ctx).XKeyfactorRequestedWith(xKeyfactorRequestedWith).QueryString(queryString).PageReturned(pageReturned).ReturnLimit(returnLimit).SortField(sortField).SortAscending(sortAscending).XKeyfactorApiVersion(xKeyfactorApiVersion).Execute()
...
func main() {
    ...
    // response from `GetPamProviders`: []PAMProviderResponseLegacy
...
> PAMProviderResponseLegacy GetPamProvidersById(ctx, id).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XKeyfactorApiVersion(xKeyfactorApiVersion).Execute()
...
func main() {
    ...
    // response from `GetPamProvidersById`: PAMProviderResponseLegacy
...
> PAMProviderResponseLegacy UpdatePamProviders(ctx).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XKeyfactorApiVersion(xKeyfactorApiVersion).PAMProviderUpdateRequestLegacy(pAMProviderUpdateRequestLegacy).Execute()
...
func main() {
    xKeyfactorRequestedWith := "APIClient" // string | Type of the request [XMLHttpRequest, APIClient]
    xKeyfactorApiVersion := "1.0" // string | Desired version of the api, if not provided defaults to v1 (optional)
    pAMProviderUpdateRequestLegacy := *openapiclient.NewPAMProviderUpdateRequestLegacy(int32(123), "Name_example", *openapiclient.NewPAMProviderCreateRequestProviderType()) // PAMProviderUpdateRequestLegacy | PAM provider properties to be used (optional)

    configuration := openapiclient.NewConfiguration(make(map[string]string))
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PAMProviderApi.UpdatePamProviders(context.Background()).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XKeyfactorApiVersion(xKeyfactorApiVersion).PAMProviderUpdateRequestLegacy(pAMProviderUpdateRequestLegacy).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PAMProviderApi.UpdatePamProviders``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdatePamProviders`: PAMProviderResponseLegacy
 ...
 **xKeyfactorRequestedWith** | **string** | Type of the request [XMLHttpRequest, APIClient] | 
 **xKeyfactorApiVersion** | **string** | Desired version of the api, if not provided defaults to v1 | 
 **pAMProviderUpdateRequestLegacy** | [**PAMProviderUpdateRequestLegacy**](PAMProviderUpdateRequestLegacy.md) | PAM provider properties to be used | 
