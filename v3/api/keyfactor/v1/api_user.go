...
*/
func (a *UserApiService) CreateSSHUsers(ctx context.Context) ApiCreateSSHUsersRequest {
...
*/
func (a *UserApiService) CreateSSHUsersAccess(ctx context.Context) ApiCreateSSHUsersAccessRequest {
...
*/
func (a *UserApiService) DeleteSSHUsersById(ctx context.Context, id int32) ApiDeleteSSHUsersByIdRequest {
...
*/
func (a *UserApiService) UpdateSSHUsers(ctx context.Context) ApiUpdateSSHUsersRequest {
