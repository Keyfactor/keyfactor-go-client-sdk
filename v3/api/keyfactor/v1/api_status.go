...
*/
func (a *StatusApiService) GetStatusEndpoints(ctx context.Context) ApiGetStatusEndpointsRequest {
...
*/
func (a *StatusApiService) GetStatusHealthCheck(ctx context.Context) ApiGetStatusHealthCheckRequest {
