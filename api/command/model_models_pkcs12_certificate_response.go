...
type _ModelsPkcs12CertificateResponse ModelsPkcs12CertificateResponse
...
func (o *ModelsPkcs12CertificateResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsPkcs12CertificateResponse := _ModelsPkcs12CertificateResponse{}

	if err = json.Unmarshal(bytes, &varModelsPkcs12CertificateResponse); err == nil {
		*o = ModelsPkcs12CertificateResponse(varModelsPkcs12CertificateResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "Pkcs12Blob")
