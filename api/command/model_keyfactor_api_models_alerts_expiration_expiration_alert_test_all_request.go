...
type _KeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest KeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest
...
func (o *KeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest := _KeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest); err == nil {
		*o = KeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest(varKeyfactorApiModelsAlertsExpirationExpirationAlertTestAllRequest)
	}
