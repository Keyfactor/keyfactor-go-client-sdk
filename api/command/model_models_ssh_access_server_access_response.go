...
type _ModelsSSHAccessServerAccessResponse ModelsSSHAccessServerAccessResponse
...
func (o *ModelsSSHAccessServerAccessResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHAccessServerAccessResponse := _ModelsSSHAccessServerAccessResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHAccessServerAccessResponse); err == nil {
		*o = ModelsSSHAccessServerAccessResponse(varModelsSSHAccessServerAccessResponse)
	}
