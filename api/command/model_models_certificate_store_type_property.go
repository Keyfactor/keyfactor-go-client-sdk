...
type _ModelsCertificateStoreTypeProperty ModelsCertificateStoreTypeProperty
...
func (o *ModelsCertificateStoreTypeProperty) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStoreTypeProperty := _ModelsCertificateStoreTypeProperty{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStoreTypeProperty); err == nil {
		*o = ModelsCertificateStoreTypeProperty(varModelsCertificateStoreTypeProperty)
	}
