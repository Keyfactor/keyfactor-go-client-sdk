...
type _ModelsQueryModelsPagedRevocationMonitoringQuery ModelsQueryModelsPagedRevocationMonitoringQuery
...
func (o *ModelsQueryModelsPagedRevocationMonitoringQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedRevocationMonitoringQuery := _ModelsQueryModelsPagedRevocationMonitoringQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedRevocationMonitoringQuery); err == nil {
		*o = ModelsQueryModelsPagedRevocationMonitoringQuery(varModelsQueryModelsPagedRevocationMonitoringQuery)
	}
