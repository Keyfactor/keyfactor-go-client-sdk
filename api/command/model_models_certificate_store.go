...
func (o *ModelsCertificateStore) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStore := _ModelsCertificateStore{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStore); err == nil {
		*o = ModelsCertificateStore(varModelsCertificateStore)
	}
