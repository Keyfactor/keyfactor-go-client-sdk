...
type _ModelsSSLNetworkDefinition ModelsSSLNetworkDefinition
...
func (o *ModelsSSLNetworkDefinition) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLNetworkDefinition := _ModelsSSLNetworkDefinition{}

	if err = json.Unmarshal(bytes, &varModelsSSLNetworkDefinition); err == nil {
		*o = ModelsSSLNetworkDefinition(varModelsSSLNetworkDefinition)
	}
