...
type _KeyfactorApiModelsMetadataFieldMetadataFieldResponse KeyfactorApiModelsMetadataFieldMetadataFieldResponse
...
func (o *KeyfactorApiModelsMetadataFieldMetadataFieldResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMetadataFieldMetadataFieldResponse := _KeyfactorApiModelsMetadataFieldMetadataFieldResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMetadataFieldMetadataFieldResponse); err == nil {
		*o = KeyfactorApiModelsMetadataFieldMetadataFieldResponse(varKeyfactorApiModelsMetadataFieldMetadataFieldResponse)
	}
