...
type _KeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest KeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest
...
func (o *KeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest := _KeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest); err == nil {
		*o = KeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest(varKeyfactorApiModelsCertificateStoresTypesCertificateStoreTypeUpdateRequest)
	}
