...
func (o *ModelsSSLScanJobPart) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLScanJobPart := _ModelsSSLScanJobPart{}

	if err = json.Unmarshal(bytes, &varModelsSSLScanJobPart); err == nil {
		*o = ModelsSSLScanJobPart(varModelsSSLScanJobPart)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "ScanJobPartId")
		delete(additionalProperties, "LogicalScanJobId")
		delete(additionalProperties, "AgentJobId")
		delete(additionalProperties, "EstimatedEndpointCount")
		delete(additionalProperties, "Status")
		delete(additionalProperties, "StatTotalEndpointCount")
		delete(additionalProperties, "StatTimedOutConnectingCount")
		delete(additionalProperties, "StatConnectionRefusedCount")
		delete(additionalProperties, "StatTimedOutDownloadingCount")
		delete(additionalProperties, "StatExceptionDownloadingCount")
		delete(additionalProperties, "StatNotSslCount")
		delete(additionalProperties, "StatBadSslHandshakeCount")
		delete(additionalProperties, "StatCertificateFoundCount")
		delete(additionalProperties, "StatNoCertificateCount")
		delete(additionalProperties, "ScanJobPartDefinitions")
