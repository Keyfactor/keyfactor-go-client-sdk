...
type _KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse
...
func (o *KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse := _KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse); err == nil {
		*o = KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse(varKeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse)
	}
