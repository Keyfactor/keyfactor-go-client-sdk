...
type _ModelsQueryModelsPagedSSHServiceAccountQuery ModelsQueryModelsPagedSSHServiceAccountQuery
...
func (o *ModelsQueryModelsPagedSSHServiceAccountQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSSHServiceAccountQuery := _ModelsQueryModelsPagedSSHServiceAccountQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSSHServiceAccountQuery); err == nil {
		*o = ModelsQueryModelsPagedSSHServiceAccountQuery(varModelsQueryModelsPagedSSHServiceAccountQuery)
	}
