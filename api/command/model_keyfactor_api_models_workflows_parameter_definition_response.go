...
func (o *KeyfactorApiModelsWorkflowsParameterDefinitionResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsParameterDefinitionResponse := _KeyfactorApiModelsWorkflowsParameterDefinitionResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsParameterDefinitionResponse); err == nil {
		*o = KeyfactorApiModelsWorkflowsParameterDefinitionResponse(varKeyfactorApiModelsWorkflowsParameterDefinitionResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "PotentialValues")
		delete(additionalProperties, "SupportTokenReplacement")
