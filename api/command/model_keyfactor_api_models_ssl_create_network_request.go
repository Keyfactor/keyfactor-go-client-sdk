...
type _KeyfactorApiModelsSslCreateNetworkRequest KeyfactorApiModelsSslCreateNetworkRequest
...
func (o *KeyfactorApiModelsSslCreateNetworkRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsSslCreateNetworkRequest := _KeyfactorApiModelsSslCreateNetworkRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsSslCreateNetworkRequest); err == nil {
		*o = KeyfactorApiModelsSslCreateNetworkRequest(varKeyfactorApiModelsSslCreateNetworkRequest)
	}
