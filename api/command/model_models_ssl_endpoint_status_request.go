...
type _ModelsSSLEndpointStatusRequest ModelsSSLEndpointStatusRequest
...
func (o *ModelsSSLEndpointStatusRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLEndpointStatusRequest := _ModelsSSLEndpointStatusRequest{}

	if err = json.Unmarshal(bytes, &varModelsSSLEndpointStatusRequest); err == nil {
		*o = ModelsSSLEndpointStatusRequest(varModelsSSLEndpointStatusRequest)
	}
