...
type _KeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest KeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest
...
func (o *KeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest := _KeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest); err == nil {
		*o = KeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest(varKeyfactorApiModelsOrchestratorJobsAcknowledgeJobRequest)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "JobAuditIds")
