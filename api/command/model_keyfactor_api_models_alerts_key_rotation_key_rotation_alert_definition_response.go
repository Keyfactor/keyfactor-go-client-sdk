...
type _KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse
...
func (o *KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse := _KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse); err == nil {
		*o = KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse(varKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse)
	}
