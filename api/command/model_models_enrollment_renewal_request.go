...
type _ModelsEnrollmentRenewalRequest ModelsEnrollmentRenewalRequest
...
func (o *ModelsEnrollmentRenewalRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsEnrollmentRenewalRequest := _ModelsEnrollmentRenewalRequest{}

	if err = json.Unmarshal(bytes, &varModelsEnrollmentRenewalRequest); err == nil {
		*o = ModelsEnrollmentRenewalRequest(varModelsEnrollmentRenewalRequest)
	}
