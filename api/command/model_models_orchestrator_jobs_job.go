...
type _ModelsOrchestratorJobsJob ModelsOrchestratorJobsJob
...
func (o *ModelsOrchestratorJobsJob) UnmarshalJSON(bytes []byte) (err error) {
	varModelsOrchestratorJobsJob := _ModelsOrchestratorJobsJob{}

	if err = json.Unmarshal(bytes, &varModelsOrchestratorJobsJob); err == nil {
		*o = ModelsOrchestratorJobsJob(varModelsOrchestratorJobsJob)
	}
