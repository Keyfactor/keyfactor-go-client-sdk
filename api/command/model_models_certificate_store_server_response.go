...
type _ModelsCertificateStoreServerResponse ModelsCertificateStoreServerResponse
...
func (o *ModelsCertificateStoreServerResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStoreServerResponse := _ModelsCertificateStoreServerResponse{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStoreServerResponse); err == nil {
		*o = ModelsCertificateStoreServerResponse(varModelsCertificateStoreServerResponse)
	}
