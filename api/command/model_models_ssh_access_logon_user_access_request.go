...
type _ModelsSSHAccessLogonUserAccessRequest ModelsSSHAccessLogonUserAccessRequest
...
func (o *ModelsSSHAccessLogonUserAccessRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHAccessLogonUserAccessRequest := _ModelsSSHAccessLogonUserAccessRequest{}

	if err = json.Unmarshal(bytes, &varModelsSSHAccessLogonUserAccessRequest); err == nil {
		*o = ModelsSSHAccessLogonUserAccessRequest(varModelsSSHAccessLogonUserAccessRequest)
	}
