...
type _ModelsSSHUsersSshUserAccessResponse ModelsSSHUsersSshUserAccessResponse
...
func (o *ModelsSSHUsersSshUserAccessResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHUsersSshUserAccessResponse := _ModelsSSHUsersSshUserAccessResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHUsersSshUserAccessResponse); err == nil {
		*o = ModelsSSHUsersSshUserAccessResponse(varModelsSSHUsersSshUserAccessResponse)
	}
