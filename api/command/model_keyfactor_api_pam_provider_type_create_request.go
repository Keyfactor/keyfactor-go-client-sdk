...
type _KeyfactorApiPAMProviderTypeCreateRequest KeyfactorApiPAMProviderTypeCreateRequest
...
func (o *KeyfactorApiPAMProviderTypeCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiPAMProviderTypeCreateRequest := _KeyfactorApiPAMProviderTypeCreateRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiPAMProviderTypeCreateRequest); err == nil {
		*o = KeyfactorApiPAMProviderTypeCreateRequest(varKeyfactorApiPAMProviderTypeCreateRequest)
	}
