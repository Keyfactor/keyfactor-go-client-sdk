...
type _ModelsSSLDisplayScanJobPart ModelsSSLDisplayScanJobPart
...
func (o *ModelsSSLDisplayScanJobPart) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLDisplayScanJobPart := _ModelsSSLDisplayScanJobPart{}

	if err = json.Unmarshal(bytes, &varModelsSSLDisplayScanJobPart); err == nil {
		*o = ModelsSSLDisplayScanJobPart(varModelsSSLDisplayScanJobPart)
	}
