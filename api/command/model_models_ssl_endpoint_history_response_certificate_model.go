...
func (o *ModelsSSLEndpointHistoryResponseCertificateModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLEndpointHistoryResponseCertificateModel := _ModelsSSLEndpointHistoryResponseCertificateModel{}

	if err = json.Unmarshal(bytes, &varModelsSSLEndpointHistoryResponseCertificateModel); err == nil {
		*o = ModelsSSLEndpointHistoryResponseCertificateModel(varModelsSSLEndpointHistoryResponseCertificateModel)
	}
