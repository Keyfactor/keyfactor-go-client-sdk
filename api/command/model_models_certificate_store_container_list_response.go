...
type _ModelsCertificateStoreContainerListResponse ModelsCertificateStoreContainerListResponse
...
func (o *ModelsCertificateStoreContainerListResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStoreContainerListResponse := _ModelsCertificateStoreContainerListResponse{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStoreContainerListResponse); err == nil {
		*o = ModelsCertificateStoreContainerListResponse(varModelsCertificateStoreContainerListResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "OverwriteSchedules")
