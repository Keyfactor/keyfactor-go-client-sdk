...
type _ModelsCertificateImportRequestModel ModelsCertificateImportRequestModel
...
func (o *ModelsCertificateImportRequestModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateImportRequestModel := _ModelsCertificateImportRequestModel{}

	if err = json.Unmarshal(bytes, &varModelsCertificateImportRequestModel); err == nil {
		*o = ModelsCertificateImportRequestModel(varModelsCertificateImportRequestModel)
	}
