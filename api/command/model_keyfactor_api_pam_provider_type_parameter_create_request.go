...
type _KeyfactorApiPAMProviderTypeParameterCreateRequest KeyfactorApiPAMProviderTypeParameterCreateRequest
...
func (o *KeyfactorApiPAMProviderTypeParameterCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiPAMProviderTypeParameterCreateRequest := _KeyfactorApiPAMProviderTypeParameterCreateRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiPAMProviderTypeParameterCreateRequest); err == nil {
		*o = KeyfactorApiPAMProviderTypeParameterCreateRequest(varKeyfactorApiPAMProviderTypeParameterCreateRequest)
	}
