...
type _ModelsQueryModelsPagedCertificateAuthorityQuery ModelsQueryModelsPagedCertificateAuthorityQuery
...
func (o *ModelsQueryModelsPagedCertificateAuthorityQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedCertificateAuthorityQuery := _ModelsQueryModelsPagedCertificateAuthorityQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedCertificateAuthorityQuery); err == nil {
		*o = ModelsQueryModelsPagedCertificateAuthorityQuery(varModelsQueryModelsPagedCertificateAuthorityQuery)
	}
