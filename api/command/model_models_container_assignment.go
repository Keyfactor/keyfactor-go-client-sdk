...
type _ModelsContainerAssignment ModelsContainerAssignment
...
func (o *ModelsContainerAssignment) UnmarshalJSON(bytes []byte) (err error) {
	varModelsContainerAssignment := _ModelsContainerAssignment{}

	if err = json.Unmarshal(bytes, &varModelsContainerAssignment); err == nil {
		*o = ModelsContainerAssignment(varModelsContainerAssignment)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "CertStoreContainerId")
		delete(additionalProperties, "NewContainerName")
		delete(additionalProperties, "NewContainerType")
		delete(additionalProperties, "KeystoreIds")
