...
type _KeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest KeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest
...
func (o *KeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest := _KeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest); err == nil {
		*o = KeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest(varKeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest)
	}
