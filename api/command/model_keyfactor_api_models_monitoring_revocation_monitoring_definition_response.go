...
type _KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse
...
func (o *KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse := _KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse); err == nil {
		*o = KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse(varKeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse)
	}
