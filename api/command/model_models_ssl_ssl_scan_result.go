...
type _ModelsSSLSslScanResult ModelsSSLSslScanResult
...
func (o *ModelsSSLSslScanResult) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLSslScanResult := _ModelsSSLSslScanResult{}

	if err = json.Unmarshal(bytes, &varModelsSSLSslScanResult); err == nil {
		*o = ModelsSSLSslScanResult(varModelsSSLSslScanResult)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "SNIName")
		delete(additionalProperties, "IpAddress")
		delete(additionalProperties, "Port")
		delete(additionalProperties, "CertificateFound")
		...
		delete(additionalProperties, "CertificateCN")
