...
type _KeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse KeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse
...
func (o *KeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse := _KeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse); err == nil {
		*o = KeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse(varKeyfactorApiModelsTemplatesTemplateEnrollmentDefaultResponse)
	}
