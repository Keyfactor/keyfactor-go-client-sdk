...
type _ModelsSSHUsersSshUserResponse ModelsSSHUsersSshUserResponse
...
func (o *ModelsSSHUsersSshUserResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHUsersSshUserResponse := _ModelsSSHUsersSshUserResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHUsersSshUserResponse); err == nil {
		*o = ModelsSSHUsersSshUserResponse(varModelsSSHUsersSshUserResponse)
	}
