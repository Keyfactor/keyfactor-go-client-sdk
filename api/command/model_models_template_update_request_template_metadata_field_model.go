...
type _ModelsTemplateUpdateRequestTemplateMetadataFieldModel ModelsTemplateUpdateRequestTemplateMetadataFieldModel
...
func (o *ModelsTemplateUpdateRequestTemplateMetadataFieldModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateUpdateRequestTemplateMetadataFieldModel := _ModelsTemplateUpdateRequestTemplateMetadataFieldModel{}

	if err = json.Unmarshal(bytes, &varModelsTemplateUpdateRequestTemplateMetadataFieldModel); err == nil {
		*o = ModelsTemplateUpdateRequestTemplateMetadataFieldModel(varModelsTemplateUpdateRequestTemplateMetadataFieldModel)
	}
