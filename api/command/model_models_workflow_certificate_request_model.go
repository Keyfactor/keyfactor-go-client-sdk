...
type _ModelsWorkflowCertificateRequestModel ModelsWorkflowCertificateRequestModel
...
func (o *ModelsWorkflowCertificateRequestModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsWorkflowCertificateRequestModel := _ModelsWorkflowCertificateRequestModel{}

	if err = json.Unmarshal(bytes, &varModelsWorkflowCertificateRequestModel); err == nil {
		*o = ModelsWorkflowCertificateRequestModel(varModelsWorkflowCertificateRequestModel)
	}
