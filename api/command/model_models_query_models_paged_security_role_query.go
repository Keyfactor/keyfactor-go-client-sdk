...
type _ModelsQueryModelsPagedSecurityRoleQuery ModelsQueryModelsPagedSecurityRoleQuery
...
func (o *ModelsQueryModelsPagedSecurityRoleQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSecurityRoleQuery := _ModelsQueryModelsPagedSecurityRoleQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSecurityRoleQuery); err == nil {
		*o = ModelsQueryModelsPagedSecurityRoleQuery(varModelsQueryModelsPagedSecurityRoleQuery)
	}
