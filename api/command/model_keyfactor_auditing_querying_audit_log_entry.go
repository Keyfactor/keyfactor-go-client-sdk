...
type _KeyfactorAuditingQueryingAuditLogEntry KeyfactorAuditingQueryingAuditLogEntry
...
func (o *KeyfactorAuditingQueryingAuditLogEntry) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorAuditingQueryingAuditLogEntry := _KeyfactorAuditingQueryingAuditLogEntry{}

	if err = json.Unmarshal(bytes, &varKeyfactorAuditingQueryingAuditLogEntry); err == nil {
		*o = KeyfactorAuditingQueryingAuditLogEntry(varKeyfactorAuditingQueryingAuditLogEntry)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "AuditIdentifier")
		delete(additionalProperties, "ImmutableIdentifier")
