...
type _ModelsQueryModelsPagedCustomReportQuery ModelsQueryModelsPagedCustomReportQuery
...
func (o *ModelsQueryModelsPagedCustomReportQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedCustomReportQuery := _ModelsQueryModelsPagedCustomReportQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedCustomReportQuery); err == nil {
		*o = ModelsQueryModelsPagedCustomReportQuery(varModelsQueryModelsPagedCustomReportQuery)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "AmmendedQuery")
