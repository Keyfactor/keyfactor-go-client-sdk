...
type _ModelsSSHServiceAccountsServiceAccountUserCreationRequest ModelsSSHServiceAccountsServiceAccountUserCreationRequest
...
func (o *ModelsSSHServiceAccountsServiceAccountUserCreationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHServiceAccountsServiceAccountUserCreationRequest := _ModelsSSHServiceAccountsServiceAccountUserCreationRequest{}

	if err = json.Unmarshal(bytes, &varModelsSSHServiceAccountsServiceAccountUserCreationRequest); err == nil {
		*o = ModelsSSHServiceAccountsServiceAccountUserCreationRequest(varModelsSSHServiceAccountsServiceAccountUserCreationRequest)
	}
