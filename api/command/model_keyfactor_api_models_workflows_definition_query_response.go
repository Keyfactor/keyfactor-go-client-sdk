...
type _KeyfactorApiModelsWorkflowsDefinitionQueryResponse KeyfactorApiModelsWorkflowsDefinitionQueryResponse
...
func (o *KeyfactorApiModelsWorkflowsDefinitionQueryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsDefinitionQueryResponse := _KeyfactorApiModelsWorkflowsDefinitionQueryResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsDefinitionQueryResponse); err == nil {
		*o = KeyfactorApiModelsWorkflowsDefinitionQueryResponse(varKeyfactorApiModelsWorkflowsDefinitionQueryResponse)
	}
