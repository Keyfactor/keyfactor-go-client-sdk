...
type _KeyfactorCommonSchedulingKeyfactorSchedule KeyfactorCommonSchedulingKeyfactorSchedule
...
func (o *KeyfactorCommonSchedulingKeyfactorSchedule) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorCommonSchedulingKeyfactorSchedule := _KeyfactorCommonSchedulingKeyfactorSchedule{}

	if err = json.Unmarshal(bytes, &varKeyfactorCommonSchedulingKeyfactorSchedule); err == nil {
		*o = KeyfactorCommonSchedulingKeyfactorSchedule(varKeyfactorCommonSchedulingKeyfactorSchedule)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ExactlyOnce")
