...
type _KeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse KeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse
...
func (o *KeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse := _KeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse); err == nil {
		*o = KeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse(varKeyfactorApiModelsCertificateAuthoritiesCertificateAuthorityTestResponse)
	}
