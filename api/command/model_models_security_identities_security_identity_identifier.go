...
type _ModelsSecurityIdentitiesSecurityIdentityIdentifier ModelsSecurityIdentitiesSecurityIdentityIdentifier
...
func (o *ModelsSecurityIdentitiesSecurityIdentityIdentifier) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSecurityIdentitiesSecurityIdentityIdentifier := _ModelsSecurityIdentitiesSecurityIdentityIdentifier{}

	if err = json.Unmarshal(bytes, &varModelsSecurityIdentitiesSecurityIdentityIdentifier); err == nil {
		*o = ModelsSecurityIdentitiesSecurityIdentityIdentifier(varModelsSecurityIdentitiesSecurityIdentityIdentifier)
	}
