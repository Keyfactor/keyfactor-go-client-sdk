...
type _ModelsReportParameters ModelsReportParameters
...
func (o *ModelsReportParameters) UnmarshalJSON(bytes []byte) (err error) {
	varModelsReportParameters := _ModelsReportParameters{}

	if err = json.Unmarshal(bytes, &varModelsReportParameters); err == nil {
		*o = ModelsReportParameters(varModelsReportParameters)
	}
