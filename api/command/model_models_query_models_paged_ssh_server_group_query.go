...
type _ModelsQueryModelsPagedSSHServerGroupQuery ModelsQueryModelsPagedSSHServerGroupQuery
...
func (o *ModelsQueryModelsPagedSSHServerGroupQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSSHServerGroupQuery := _ModelsQueryModelsPagedSSHServerGroupQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSSHServerGroupQuery); err == nil {
		*o = ModelsQueryModelsPagedSSHServerGroupQuery(varModelsQueryModelsPagedSSHServerGroupQuery)
	}
