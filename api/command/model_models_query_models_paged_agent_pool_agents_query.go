...
// checks if the ModelsQueryModelsPagedAgentPoolAgentsQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedAgentPoolAgentsQuery{}
...
type _ModelsQueryModelsPagedAgentPoolAgentsQuery ModelsQueryModelsPagedAgentPoolAgentsQuery
...
func NewModelsQueryModelsPagedAgentPoolAgentsQuery() *ModelsQueryModelsPagedAgentPoolAgentsQuery {
	this := ModelsQueryModelsPagedAgentPoolAgentsQuery{}
	return &this
}
...
func (o ModelsQueryModelsPagedAgentPoolAgentsQuery) MarshalJSON() ([]byte, error) {
...
func (o *ModelsQueryModelsPagedAgentPoolAgentsQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedAgentPoolAgentsQuery := _ModelsQueryModelsPagedAgentPoolAgentsQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedAgentPoolAgentsQuery); err == nil {
		*o = ModelsQueryModelsPagedAgentPoolAgentsQuery(varModelsQueryModelsPagedAgentPoolAgentsQuery)
	}
...
type NullableModelsQueryModelsPagedAgentPoolAgentsQuery struct {
	value *ModelsQueryModelsPagedAgentPoolAgentsQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedAgentPoolAgentsQuery) Get() *ModelsQueryModelsPagedAgentPoolAgentsQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedAgentPoolAgentsQuery) Set(val *ModelsQueryModelsPagedAgentPoolAgentsQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedAgentPoolAgentsQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedAgentPoolAgentsQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedAgentPoolAgentsQuery(val *ModelsQueryModelsPagedAgentPoolAgentsQuery) *NullableModelsQueryModelsPagedAgentPoolAgentsQuery {
	return &NullableModelsQueryModelsPagedAgentPoolAgentsQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedAgentPoolAgentsQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedAgentPoolAgentsQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
