...
func (o *ModelsEnrollmentExistingEnrollmentManagementRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsEnrollmentExistingEnrollmentManagementRequest := _ModelsEnrollmentExistingEnrollmentManagementRequest{}

	if err = json.Unmarshal(bytes, &varModelsEnrollmentExistingEnrollmentManagementRequest); err == nil {
		*o = ModelsEnrollmentExistingEnrollmentManagementRequest(varModelsEnrollmentExistingEnrollmentManagementRequest)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "ExistingCertificateId")
