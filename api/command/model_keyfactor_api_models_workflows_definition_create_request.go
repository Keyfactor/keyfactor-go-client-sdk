...
type _KeyfactorApiModelsWorkflowsDefinitionCreateRequest KeyfactorApiModelsWorkflowsDefinitionCreateRequest
...
func (o *KeyfactorApiModelsWorkflowsDefinitionCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsDefinitionCreateRequest := _KeyfactorApiModelsWorkflowsDefinitionCreateRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsDefinitionCreateRequest); err == nil {
		*o = KeyfactorApiModelsWorkflowsDefinitionCreateRequest(varKeyfactorApiModelsWorkflowsDefinitionCreateRequest)
	}
