...
type _ModelsQueryModelsWorkflowWorkflowInstanceQuery ModelsQueryModelsWorkflowWorkflowInstanceQuery
...
func (o *ModelsQueryModelsWorkflowWorkflowInstanceQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsWorkflowWorkflowInstanceQuery := _ModelsQueryModelsWorkflowWorkflowInstanceQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsWorkflowWorkflowInstanceQuery); err == nil {
		*o = ModelsQueryModelsWorkflowWorkflowInstanceQuery(varModelsQueryModelsWorkflowWorkflowInstanceQuery)
	}
