...
type _KeyfactorApiModelsCertificatesCertificateQueryRequest KeyfactorApiModelsCertificatesCertificateQueryRequest
...
func (o *KeyfactorApiModelsCertificatesCertificateQueryRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsCertificatesCertificateQueryRequest := _KeyfactorApiModelsCertificatesCertificateQueryRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsCertificatesCertificateQueryRequest); err == nil {
		*o = KeyfactorApiModelsCertificatesCertificateQueryRequest(varKeyfactorApiModelsCertificatesCertificateQueryRequest)
	}
