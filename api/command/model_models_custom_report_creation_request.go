...
type _ModelsCustomReportCreationRequest ModelsCustomReportCreationRequest
...
func (o *ModelsCustomReportCreationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCustomReportCreationRequest := _ModelsCustomReportCreationRequest{}

	if err = json.Unmarshal(bytes, &varModelsCustomReportCreationRequest); err == nil {
		*o = ModelsCustomReportCreationRequest(varModelsCustomReportCreationRequest)
	}
