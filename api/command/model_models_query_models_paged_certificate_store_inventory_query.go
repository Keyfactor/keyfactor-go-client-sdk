...
type _ModelsQueryModelsPagedCertificateStoreInventoryQuery ModelsQueryModelsPagedCertificateStoreInventoryQuery
...
func (o *ModelsQueryModelsPagedCertificateStoreInventoryQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedCertificateStoreInventoryQuery := _ModelsQueryModelsPagedCertificateStoreInventoryQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedCertificateStoreInventoryQuery); err == nil {
		*o = ModelsQueryModelsPagedCertificateStoreInventoryQuery(varModelsQueryModelsPagedCertificateStoreInventoryQuery)
	}
