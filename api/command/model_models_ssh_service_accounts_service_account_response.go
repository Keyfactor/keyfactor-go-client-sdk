...
type _ModelsSSHServiceAccountsServiceAccountResponse ModelsSSHServiceAccountsServiceAccountResponse
...
func (o *ModelsSSHServiceAccountsServiceAccountResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHServiceAccountsServiceAccountResponse := _ModelsSSHServiceAccountsServiceAccountResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHServiceAccountsServiceAccountResponse); err == nil {
		*o = ModelsSSHServiceAccountsServiceAccountResponse(varModelsSSHServiceAccountsServiceAccountResponse)
	}
