...
type _KeyfactorApiModelsEventHandlerEventHandlerParameterRequest KeyfactorApiModelsEventHandlerEventHandlerParameterRequest
...
func (o *KeyfactorApiModelsEventHandlerEventHandlerParameterRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsEventHandlerEventHandlerParameterRequest := _KeyfactorApiModelsEventHandlerEventHandlerParameterRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsEventHandlerEventHandlerParameterRequest); err == nil {
		*o = KeyfactorApiModelsEventHandlerEventHandlerParameterRequest(varKeyfactorApiModelsEventHandlerEventHandlerParameterRequest)
	}
