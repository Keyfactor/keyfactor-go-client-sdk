...
type _ModelsEnrollmentPFXEnrollmentResponse ModelsEnrollmentPFXEnrollmentResponse
...
func (o *ModelsEnrollmentPFXEnrollmentResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsEnrollmentPFXEnrollmentResponse := _ModelsEnrollmentPFXEnrollmentResponse{}

	if err = json.Unmarshal(bytes, &varModelsEnrollmentPFXEnrollmentResponse); err == nil {
		*o = ModelsEnrollmentPFXEnrollmentResponse(varModelsEnrollmentPFXEnrollmentResponse)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "CertificateInformation")
