...
// checks if the ModelsQueryModelsPagedSSHUserQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedSSHUserQuery{}
...
type _ModelsQueryModelsPagedSSHUserQuery ModelsQueryModelsPagedSSHUserQuery
...
func NewModelsQueryModelsPagedSSHUserQuery() *ModelsQueryModelsPagedSSHUserQuery {
	this := ModelsQueryModelsPagedSSHUserQuery{}
	return &this
}
...
func (o *ModelsQueryModelsPagedSSHUserQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSSHUserQuery := _ModelsQueryModelsPagedSSHUserQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSSHUserQuery); err == nil {
		*o = ModelsQueryModelsPagedSSHUserQuery(varModelsQueryModelsPagedSSHUserQuery)
	}
...
type NullableModelsQueryModelsPagedSSHUserQuery struct {
	value *ModelsQueryModelsPagedSSHUserQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedSSHUserQuery) Get() *ModelsQueryModelsPagedSSHUserQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedSSHUserQuery) Set(val *ModelsQueryModelsPagedSSHUserQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedSSHUserQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedSSHUserQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedSSHUserQuery(val *ModelsQueryModelsPagedSSHUserQuery) *NullableModelsQueryModelsPagedSSHUserQuery {
	return &NullableModelsQueryModelsPagedSSHUserQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedSSHUserQuery) MarshalJSON() ([]byte, error) {
