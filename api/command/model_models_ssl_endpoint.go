...
type _ModelsSSLEndpoint ModelsSSLEndpoint
...
func (o *ModelsSSLEndpoint) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLEndpoint := _ModelsSSLEndpoint{}

	if err = json.Unmarshal(bytes, &varModelsSSLEndpoint); err == nil {
		*o = ModelsSSLEndpoint(varModelsSSLEndpoint)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "LastHistoryId")
		delete(additionalProperties, "IpAddressBytes")
