...
type _ModelsQueryModelsPagedAuditLogQuery ModelsQueryModelsPagedAuditLogQuery
...
func (o *ModelsQueryModelsPagedAuditLogQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedAuditLogQuery := _ModelsQueryModelsPagedAuditLogQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedAuditLogQuery); err == nil {
		*o = ModelsQueryModelsPagedAuditLogQuery(varModelsQueryModelsPagedAuditLogQuery)
	}
