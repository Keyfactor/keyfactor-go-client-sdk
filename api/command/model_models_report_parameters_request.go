...
type _ModelsReportParametersRequest ModelsReportParametersRequest
...
func (o *ModelsReportParametersRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsReportParametersRequest := _ModelsReportParametersRequest{}

	if err = json.Unmarshal(bytes, &varModelsReportParametersRequest); err == nil {
		*o = ModelsReportParametersRequest(varModelsReportParametersRequest)
	}
