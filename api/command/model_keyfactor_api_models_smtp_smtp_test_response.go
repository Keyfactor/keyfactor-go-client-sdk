...
type _KeyfactorAPIModelsSMTPSMTPTestResponse KeyfactorAPIModelsSMTPSMTPTestResponse
...
func (o *KeyfactorAPIModelsSMTPSMTPTestResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorAPIModelsSMTPSMTPTestResponse := _KeyfactorAPIModelsSMTPSMTPTestResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorAPIModelsSMTPSMTPTestResponse); err == nil {
		*o = KeyfactorAPIModelsSMTPSMTPTestResponse(varKeyfactorAPIModelsSMTPSMTPTestResponse)
	}
