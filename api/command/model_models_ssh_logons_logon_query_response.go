...
func (o *ModelsSSHLogonsLogonQueryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHLogonsLogonQueryResponse := _ModelsSSHLogonsLogonQueryResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHLogonsLogonQueryResponse); err == nil {
		*o = ModelsSSHLogonsLogonQueryResponse(varModelsSSHLogonsLogonQueryResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ServerUnderManagement")
