...
// checks if the ModelsQueryModelsPagedDeniedAlertQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedDeniedAlertQuery{}
...
type _ModelsQueryModelsPagedDeniedAlertQuery ModelsQueryModelsPagedDeniedAlertQuery
...
func NewModelsQueryModelsPagedDeniedAlertQuery() *ModelsQueryModelsPagedDeniedAlertQuery {
	this := ModelsQueryModelsPagedDeniedAlertQuery{}
	return &this
}
...
func (o *ModelsQueryModelsPagedDeniedAlertQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedDeniedAlertQuery := _ModelsQueryModelsPagedDeniedAlertQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedDeniedAlertQuery); err == nil {
		*o = ModelsQueryModelsPagedDeniedAlertQuery(varModelsQueryModelsPagedDeniedAlertQuery)
	}
...
type NullableModelsQueryModelsPagedDeniedAlertQuery struct {
	value *ModelsQueryModelsPagedDeniedAlertQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedDeniedAlertQuery) Get() *ModelsQueryModelsPagedDeniedAlertQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedDeniedAlertQuery) Set(val *ModelsQueryModelsPagedDeniedAlertQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedDeniedAlertQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedDeniedAlertQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedDeniedAlertQuery(val *ModelsQueryModelsPagedDeniedAlertQuery) *NullableModelsQueryModelsPagedDeniedAlertQuery {
	return &NullableModelsQueryModelsPagedDeniedAlertQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedDeniedAlertQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedDeniedAlertQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
