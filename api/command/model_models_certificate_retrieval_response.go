...
func (o *ModelsCertificateRetrievalResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateRetrievalResponse := _ModelsCertificateRetrievalResponse{}

	if err = json.Unmarshal(bytes, &varModelsCertificateRetrievalResponse); err == nil {
		*o = ModelsCertificateRetrievalResponse(varModelsCertificateRetrievalResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ImportDate")
		...
		delete(additionalProperties, "CertState")
		delete(additionalProperties, "KeySizeInBits")
		delete(additionalProperties, "KeyType")
		delete(additionalProperties, "RequesterId")
		delete(additionalProperties, "IssuedOU")
		delete(additionalProperties, "IssuedEmail")
		delete(additionalProperties, "KeyUsage")
		delete(additionalProperties, "SigningAlgorithm")
		delete(additionalProperties, "CertStateString")
		delete(additionalProperties, "KeyTypeString")
		delete(additionalProperties, "RevocationEffDate")
		delete(additionalProperties, "RevocationReason")
		delete(additionalProperties, "RevocationComment")
		delete(additionalProperties, "CertificateAuthorityId")
		delete(additionalProperties, "CertificateAuthorityName")
		delete(additionalProperties, "TemplateName")
		delete(additionalProperties, "ArchivedKey")
		delete(additionalProperties, "HasPrivateKey")
		delete(additionalProperties, "PrincipalName")
		delete(additionalProperties, "CertRequestId")
		delete(additionalProperties, "RequesterName")
		delete(additionalProperties, "ContentBytes")
		delete(additionalProperties, "ExtendedKeyUsages")
		delete(additionalProperties, "SubjectAltNameElements")
		delete(additionalProperties, "CRLDistributionPoints")
		delete(additionalProperties, "LocationsCount")
		delete(additionalProperties, "SSLLocations")
		delete(additionalProperties, "Locations")
		delete(additionalProperties, "Metadata")
		delete(additionalProperties, "CertificateKeyId")
		delete(additionalProperties, "CARowIndex")
		delete(additionalProperties, "CARecordId")
		delete(additionalProperties, "DetailedKeyUsage")
		delete(additionalProperties, "KeyRecoverable")
