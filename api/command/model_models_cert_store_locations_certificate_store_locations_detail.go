...
type _ModelsCertStoreLocationsCertificateStoreLocationsDetail ModelsCertStoreLocationsCertificateStoreLocationsDetail
...
func (o *ModelsCertStoreLocationsCertificateStoreLocationsDetail) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertStoreLocationsCertificateStoreLocationsDetail := _ModelsCertStoreLocationsCertificateStoreLocationsDetail{}

	if err = json.Unmarshal(bytes, &varModelsCertStoreLocationsCertificateStoreLocationsDetail); err == nil {
		*o = ModelsCertStoreLocationsCertificateStoreLocationsDetail(varModelsCertStoreLocationsCertificateStoreLocationsDetail)
	}
