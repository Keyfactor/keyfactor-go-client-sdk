...
func (o *ModelsEnrollmentCSREnrollmentRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsEnrollmentCSREnrollmentRequest := _ModelsEnrollmentCSREnrollmentRequest{}

	if err = json.Unmarshal(bytes, &varModelsEnrollmentCSREnrollmentRequest); err == nil {
		*o = ModelsEnrollmentCSREnrollmentRequest(varModelsEnrollmentCSREnrollmentRequest)
	}
