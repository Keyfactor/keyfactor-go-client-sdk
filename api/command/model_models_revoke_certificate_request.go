...
type _ModelsRevokeCertificateRequest ModelsRevokeCertificateRequest
...
func (o *ModelsRevokeCertificateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsRevokeCertificateRequest := _ModelsRevokeCertificateRequest{}

	if err = json.Unmarshal(bytes, &varModelsRevokeCertificateRequest); err == nil {
		*o = ModelsRevokeCertificateRequest(varModelsRevokeCertificateRequest)
	}
