...
type _ModelsQueryModelsPagedReportScheduleQuery ModelsQueryModelsPagedReportScheduleQuery
...
func (o *ModelsQueryModelsPagedReportScheduleQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedReportScheduleQuery := _ModelsQueryModelsPagedReportScheduleQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedReportScheduleQuery); err == nil {
		*o = ModelsQueryModelsPagedReportScheduleQuery(varModelsQueryModelsPagedReportScheduleQuery)
	}
