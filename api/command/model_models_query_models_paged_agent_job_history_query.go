...
// checks if the ModelsQueryModelsPagedAgentJobHistoryQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedAgentJobHistoryQuery{}
...
type _ModelsQueryModelsPagedAgentJobHistoryQuery ModelsQueryModelsPagedAgentJobHistoryQuery
...
func (o ModelsQueryModelsPagedAgentJobHistoryQuery) MarshalJSON() ([]byte, error) {
...
func (o *ModelsQueryModelsPagedAgentJobHistoryQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedAgentJobHistoryQuery := _ModelsQueryModelsPagedAgentJobHistoryQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedAgentJobHistoryQuery); err == nil {
		*o = ModelsQueryModelsPagedAgentJobHistoryQuery(varModelsQueryModelsPagedAgentJobHistoryQuery)
	}
...
type NullableModelsQueryModelsPagedAgentJobHistoryQuery struct {
	value *ModelsQueryModelsPagedAgentJobHistoryQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedAgentJobHistoryQuery) Get() *ModelsQueryModelsPagedAgentJobHistoryQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedAgentJobHistoryQuery) Set(val *ModelsQueryModelsPagedAgentJobHistoryQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedAgentJobHistoryQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedAgentJobHistoryQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedAgentJobHistoryQuery(val *ModelsQueryModelsPagedAgentJobHistoryQuery) *NullableModelsQueryModelsPagedAgentJobHistoryQuery {
	return &NullableModelsQueryModelsPagedAgentJobHistoryQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedAgentJobHistoryQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedAgentJobHistoryQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
