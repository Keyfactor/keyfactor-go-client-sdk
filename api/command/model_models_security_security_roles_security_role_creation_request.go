...
type _ModelsSecuritySecurityRolesSecurityRoleCreationRequest ModelsSecuritySecurityRolesSecurityRoleCreationRequest
...
func (o *ModelsSecuritySecurityRolesSecurityRoleCreationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSecuritySecurityRolesSecurityRoleCreationRequest := _ModelsSecuritySecurityRolesSecurityRoleCreationRequest{}

	if err = json.Unmarshal(bytes, &varModelsSecuritySecurityRolesSecurityRoleCreationRequest); err == nil {
		*o = ModelsSecuritySecurityRolesSecurityRoleCreationRequest(varModelsSecuritySecurityRolesSecurityRoleCreationRequest)
	}
