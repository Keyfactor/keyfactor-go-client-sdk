...
type _KeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel KeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel
...
func (o *KeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel := _KeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel); err == nil {
		*o = KeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel(varKeyfactorApiModelsMacEnrollmentMacEnrollmentAPIModel)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "UseMetadata")
		delete(additionalProperties, "MetadataField")
		delete(additionalProperties, "MetadataValue")
