...
type _KeyfactorApiPAMProviderTypeResponse KeyfactorApiPAMProviderTypeResponse
...
func (o *KeyfactorApiPAMProviderTypeResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiPAMProviderTypeResponse := _KeyfactorApiPAMProviderTypeResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiPAMProviderTypeResponse); err == nil {
		*o = KeyfactorApiPAMProviderTypeResponse(varKeyfactorApiPAMProviderTypeResponse)
	}
