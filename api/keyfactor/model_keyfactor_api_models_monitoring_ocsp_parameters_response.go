...
type _KeyfactorApiModelsMonitoringOCSPParametersResponse KeyfactorApiModelsMonitoringOCSPParametersResponse
...
func (o *KeyfactorApiModelsMonitoringOCSPParametersResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMonitoringOCSPParametersResponse := _KeyfactorApiModelsMonitoringOCSPParametersResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMonitoringOCSPParametersResponse); err == nil {
		*o = KeyfactorApiModelsMonitoringOCSPParametersResponse(varKeyfactorApiModelsMonitoringOCSPParametersResponse)
	}
