...
type _KeyfactorApiModelsMonitoringEmailRequest KeyfactorApiModelsMonitoringEmailRequest
...
func (o *KeyfactorApiModelsMonitoringEmailRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMonitoringEmailRequest := _KeyfactorApiModelsMonitoringEmailRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMonitoringEmailRequest); err == nil {
		*o = KeyfactorApiModelsMonitoringEmailRequest(varKeyfactorApiModelsMonitoringEmailRequest)
	}
