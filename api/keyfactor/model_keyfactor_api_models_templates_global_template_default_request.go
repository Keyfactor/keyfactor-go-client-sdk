...
type _KeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest KeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest
...
func (o *KeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest := _KeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest); err == nil {
		*o = KeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest(varKeyfactorApiModelsTemplatesGlobalTemplateDefaultRequest)
	}
