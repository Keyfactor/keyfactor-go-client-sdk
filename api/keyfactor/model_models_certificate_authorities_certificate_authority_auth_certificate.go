...
type _ModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate ModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate
...
func (o *ModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate := _ModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate{}

	if err = json.Unmarshal(bytes, &varModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate); err == nil {
		*o = ModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate(varModelsCertificateAuthoritiesCertificateAuthorityAuthCertificate)
	}
