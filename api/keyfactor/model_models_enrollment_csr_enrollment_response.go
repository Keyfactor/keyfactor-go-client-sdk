...
func (o *ModelsEnrollmentCSREnrollmentResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsEnrollmentCSREnrollmentResponse := _ModelsEnrollmentCSREnrollmentResponse{}

	if err = json.Unmarshal(bytes, &varModelsEnrollmentCSREnrollmentResponse); err == nil {
		*o = ModelsEnrollmentCSREnrollmentResponse(varModelsEnrollmentCSREnrollmentResponse)
	}
