...
type _ModelsInvalidKeystore ModelsInvalidKeystore
...
func (o *ModelsInvalidKeystore) UnmarshalJSON(bytes []byte) (err error) {
	varModelsInvalidKeystore := _ModelsInvalidKeystore{}

	if err = json.Unmarshal(bytes, &varModelsInvalidKeystore); err == nil {
		*o = ModelsInvalidKeystore(varModelsInvalidKeystore)
	}
