...
type _ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel
...
func (o *ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel := _ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel{}

	if err = json.Unmarshal(bytes, &varModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel); err == nil {
		*o = ModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel(varModelsTemplateRetrievalResponseTemplateEnrollmentFieldModel)
	}
