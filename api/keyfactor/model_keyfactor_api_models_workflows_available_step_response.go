...
func (o *KeyfactorApiModelsWorkflowsAvailableStepResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsAvailableStepResponse := _KeyfactorApiModelsWorkflowsAvailableStepResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsAvailableStepResponse); err == nil {
		*o = KeyfactorApiModelsWorkflowsAvailableStepResponse(varKeyfactorApiModelsWorkflowsAvailableStepResponse)
	}
