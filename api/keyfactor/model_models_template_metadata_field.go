...
type _ModelsTemplateMetadataField ModelsTemplateMetadataField
...
func (o *ModelsTemplateMetadataField) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateMetadataField := _ModelsTemplateMetadataField{}

	if err = json.Unmarshal(bytes, &varModelsTemplateMetadataField); err == nil {
		*o = ModelsTemplateMetadataField(varModelsTemplateMetadataField)
	}
