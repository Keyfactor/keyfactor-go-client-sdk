...
type _ModelsCertificateLocationSpecifier ModelsCertificateLocationSpecifier
...
func (o *ModelsCertificateLocationSpecifier) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateLocationSpecifier := _ModelsCertificateLocationSpecifier{}

	if err = json.Unmarshal(bytes, &varModelsCertificateLocationSpecifier); err == nil {
		*o = ModelsCertificateLocationSpecifier(varModelsCertificateLocationSpecifier)
	}
