...
type _ModelsExtendedKeyUsage ModelsExtendedKeyUsage
...
func (o *ModelsExtendedKeyUsage) UnmarshalJSON(bytes []byte) (err error) {
	varModelsExtendedKeyUsage := _ModelsExtendedKeyUsage{}

	if err = json.Unmarshal(bytes, &varModelsExtendedKeyUsage); err == nil {
		*o = ModelsExtendedKeyUsage(varModelsExtendedKeyUsage)
	}
