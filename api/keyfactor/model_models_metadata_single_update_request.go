...
type _ModelsMetadataSingleUpdateRequest ModelsMetadataSingleUpdateRequest
...
func (o *ModelsMetadataSingleUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsMetadataSingleUpdateRequest := _ModelsMetadataSingleUpdateRequest{}

	if err = json.Unmarshal(bytes, &varModelsMetadataSingleUpdateRequest); err == nil {
		*o = ModelsMetadataSingleUpdateRequest(varModelsMetadataSingleUpdateRequest)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "OverwriteExisting")
