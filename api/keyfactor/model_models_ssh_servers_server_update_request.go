...
type _ModelsSSHServersServerUpdateRequest ModelsSSHServersServerUpdateRequest
...
func (o *ModelsSSHServersServerUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHServersServerUpdateRequest := _ModelsSSHServersServerUpdateRequest{}

	if err = json.Unmarshal(bytes, &varModelsSSHServersServerUpdateRequest); err == nil {
		*o = ModelsSSHServersServerUpdateRequest(varModelsSSHServersServerUpdateRequest)
	}
