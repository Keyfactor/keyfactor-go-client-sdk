...
type _ModelsQueryModelsPagedReportQuery ModelsQueryModelsPagedReportQuery
...
func (o *ModelsQueryModelsPagedReportQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedReportQuery := _ModelsQueryModelsPagedReportQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedReportQuery); err == nil {
		*o = ModelsQueryModelsPagedReportQuery(varModelsQueryModelsPagedReportQuery)
	}
