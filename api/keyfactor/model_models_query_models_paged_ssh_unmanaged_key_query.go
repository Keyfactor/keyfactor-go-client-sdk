...
type _ModelsQueryModelsPagedSSHUnmanagedKeyQuery ModelsQueryModelsPagedSSHUnmanagedKeyQuery
...
func (o *ModelsQueryModelsPagedSSHUnmanagedKeyQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSSHUnmanagedKeyQuery := _ModelsQueryModelsPagedSSHUnmanagedKeyQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSSHUnmanagedKeyQuery); err == nil {
		*o = ModelsQueryModelsPagedSSHUnmanagedKeyQuery(varModelsQueryModelsPagedSSHUnmanagedKeyQuery)
	}
