...
type _ModelsSSHServerGroupsServerGroupCreationRequest ModelsSSHServerGroupsServerGroupCreationRequest
...
func (o *ModelsSSHServerGroupsServerGroupCreationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHServerGroupsServerGroupCreationRequest := _ModelsSSHServerGroupsServerGroupCreationRequest{}

	if err = json.Unmarshal(bytes, &varModelsSSHServerGroupsServerGroupCreationRequest); err == nil {
		*o = ModelsSSHServerGroupsServerGroupCreationRequest(varModelsSSHServerGroupsServerGroupCreationRequest)
	}
