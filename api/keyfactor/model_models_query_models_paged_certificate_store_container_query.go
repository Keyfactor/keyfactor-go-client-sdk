...
// checks if the ModelsQueryModelsPagedCertificateStoreContainerQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedCertificateStoreContainerQuery{}
...
type _ModelsQueryModelsPagedCertificateStoreContainerQuery ModelsQueryModelsPagedCertificateStoreContainerQuery
...
func NewModelsQueryModelsPagedCertificateStoreContainerQuery() *ModelsQueryModelsPagedCertificateStoreContainerQuery {
	this := ModelsQueryModelsPagedCertificateStoreContainerQuery{}
	return &this
}
...
func (o ModelsQueryModelsPagedCertificateStoreContainerQuery) MarshalJSON() ([]byte, error) {
...
func (o ModelsQueryModelsPagedCertificateStoreContainerQuery) ToMap() (map[string]interface{}, error) {
...
func (o *ModelsQueryModelsPagedCertificateStoreContainerQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedCertificateStoreContainerQuery := _ModelsQueryModelsPagedCertificateStoreContainerQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedCertificateStoreContainerQuery); err == nil {
		*o = ModelsQueryModelsPagedCertificateStoreContainerQuery(varModelsQueryModelsPagedCertificateStoreContainerQuery)
	}
...
type NullableModelsQueryModelsPagedCertificateStoreContainerQuery struct {
	value *ModelsQueryModelsPagedCertificateStoreContainerQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedCertificateStoreContainerQuery) Get() *ModelsQueryModelsPagedCertificateStoreContainerQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedCertificateStoreContainerQuery) Set(val *ModelsQueryModelsPagedCertificateStoreContainerQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedCertificateStoreContainerQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedCertificateStoreContainerQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedCertificateStoreContainerQuery(val *ModelsQueryModelsPagedCertificateStoreContainerQuery) *NullableModelsQueryModelsPagedCertificateStoreContainerQuery {
	return &NullableModelsQueryModelsPagedCertificateStoreContainerQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedCertificateStoreContainerQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedCertificateStoreContainerQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
