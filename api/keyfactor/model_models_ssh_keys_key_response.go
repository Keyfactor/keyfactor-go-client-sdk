...
type _ModelsSSHKeysKeyResponse ModelsSSHKeysKeyResponse
...
func (o *ModelsSSHKeysKeyResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHKeysKeyResponse := _ModelsSSHKeysKeyResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHKeysKeyResponse); err == nil {
		*o = ModelsSSHKeysKeyResponse(varModelsSSHKeysKeyResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "StaleDate")
