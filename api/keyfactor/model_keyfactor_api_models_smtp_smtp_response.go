...
func (o *KeyfactorAPIModelsSMTPSMTPResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorAPIModelsSMTPSMTPResponse := _KeyfactorAPIModelsSMTPSMTPResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorAPIModelsSMTPSMTPResponse); err == nil {
		*o = KeyfactorAPIModelsSMTPSMTPResponse(varKeyfactorAPIModelsSMTPSMTPResponse)
	}
