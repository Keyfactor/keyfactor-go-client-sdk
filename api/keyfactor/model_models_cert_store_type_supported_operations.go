...
type _ModelsCertStoreTypeSupportedOperations ModelsCertStoreTypeSupportedOperations
...
func (o *ModelsCertStoreTypeSupportedOperations) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertStoreTypeSupportedOperations := _ModelsCertStoreTypeSupportedOperations{}

	if err = json.Unmarshal(bytes, &varModelsCertStoreTypeSupportedOperations); err == nil {
		*o = ModelsCertStoreTypeSupportedOperations(varModelsCertStoreTypeSupportedOperations)
	}
