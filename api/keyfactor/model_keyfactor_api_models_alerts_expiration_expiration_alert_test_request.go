...
type _KeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest KeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest
...
func (o *KeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest := _KeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest); err == nil {
		*o = KeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest(varKeyfactorApiModelsAlertsExpirationExpirationAlertTestRequest)
	}
