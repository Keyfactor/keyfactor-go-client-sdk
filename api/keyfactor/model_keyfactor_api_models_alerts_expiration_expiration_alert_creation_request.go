...
func (o *KeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest := _KeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest); err == nil {
		*o = KeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest(varKeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest)
	}
