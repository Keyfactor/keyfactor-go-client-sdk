...
type _ModelsOrchestratorJobsScheduleBulkJobRequest ModelsOrchestratorJobsScheduleBulkJobRequest
...
func (o *ModelsOrchestratorJobsScheduleBulkJobRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsOrchestratorJobsScheduleBulkJobRequest := _ModelsOrchestratorJobsScheduleBulkJobRequest{}

	if err = json.Unmarshal(bytes, &varModelsOrchestratorJobsScheduleBulkJobRequest); err == nil {
		*o = ModelsOrchestratorJobsScheduleBulkJobRequest(varModelsOrchestratorJobsScheduleBulkJobRequest)
	}
