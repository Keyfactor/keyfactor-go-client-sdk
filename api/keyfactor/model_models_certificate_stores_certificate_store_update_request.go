...
type _ModelsCertificateStoresCertificateStoreUpdateRequest ModelsCertificateStoresCertificateStoreUpdateRequest
...
func (o *ModelsCertificateStoresCertificateStoreUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStoresCertificateStoreUpdateRequest := _ModelsCertificateStoresCertificateStoreUpdateRequest{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStoresCertificateStoreUpdateRequest); err == nil {
		*o = ModelsCertificateStoresCertificateStoreUpdateRequest(varModelsCertificateStoresCertificateStoreUpdateRequest)
	}
