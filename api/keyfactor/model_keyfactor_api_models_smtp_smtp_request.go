...
type _KeyfactorAPIModelsSMTPSMTPRequest KeyfactorAPIModelsSMTPSMTPRequest
...
func (o *KeyfactorAPIModelsSMTPSMTPRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorAPIModelsSMTPSMTPRequest := _KeyfactorAPIModelsSMTPSMTPRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorAPIModelsSMTPSMTPRequest); err == nil {
		*o = KeyfactorAPIModelsSMTPSMTPRequest(varKeyfactorAPIModelsSMTPSMTPRequest)
	}
