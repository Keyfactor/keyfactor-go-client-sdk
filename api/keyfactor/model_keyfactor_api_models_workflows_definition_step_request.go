...
func (o *KeyfactorApiModelsWorkflowsDefinitionStepRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsDefinitionStepRequest := _KeyfactorApiModelsWorkflowsDefinitionStepRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsDefinitionStepRequest); err == nil {
		*o = KeyfactorApiModelsWorkflowsDefinitionStepRequest(varKeyfactorApiModelsWorkflowsDefinitionStepRequest)
	}
