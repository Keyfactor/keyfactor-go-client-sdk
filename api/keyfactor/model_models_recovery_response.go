...
type _ModelsRecoveryResponse ModelsRecoveryResponse
...
func (o *ModelsRecoveryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsRecoveryResponse := _ModelsRecoveryResponse{}

	if err = json.Unmarshal(bytes, &varModelsRecoveryResponse); err == nil {
		*o = ModelsRecoveryResponse(varModelsRecoveryResponse)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "PFX")
