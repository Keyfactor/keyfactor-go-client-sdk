...
type _ModelsQueryModelsPagedMetadataFieldQuery ModelsQueryModelsPagedMetadataFieldQuery
...
func (o *ModelsQueryModelsPagedMetadataFieldQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedMetadataFieldQuery := _ModelsQueryModelsPagedMetadataFieldQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedMetadataFieldQuery); err == nil {
		*o = ModelsQueryModelsPagedMetadataFieldQuery(varModelsQueryModelsPagedMetadataFieldQuery)
	}
