...
// checks if the ModelsQueryModelsPagedIssuedAlertQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedIssuedAlertQuery{}
...
type _ModelsQueryModelsPagedIssuedAlertQuery ModelsQueryModelsPagedIssuedAlertQuery
...
func NewModelsQueryModelsPagedIssuedAlertQuery() *ModelsQueryModelsPagedIssuedAlertQuery {
	this := ModelsQueryModelsPagedIssuedAlertQuery{}
	return &this
}
...
func (o *ModelsQueryModelsPagedIssuedAlertQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedIssuedAlertQuery := _ModelsQueryModelsPagedIssuedAlertQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedIssuedAlertQuery); err == nil {
		*o = ModelsQueryModelsPagedIssuedAlertQuery(varModelsQueryModelsPagedIssuedAlertQuery)
	}
...
type NullableModelsQueryModelsPagedIssuedAlertQuery struct {
	value *ModelsQueryModelsPagedIssuedAlertQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedIssuedAlertQuery) Get() *ModelsQueryModelsPagedIssuedAlertQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedIssuedAlertQuery) Set(val *ModelsQueryModelsPagedIssuedAlertQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedIssuedAlertQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedIssuedAlertQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedIssuedAlertQuery(val *ModelsQueryModelsPagedIssuedAlertQuery) *NullableModelsQueryModelsPagedIssuedAlertQuery {
	return &NullableModelsQueryModelsPagedIssuedAlertQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedIssuedAlertQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedIssuedAlertQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
