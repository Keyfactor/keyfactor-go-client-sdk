...
type _KeyfactorApiModelsCertificateStoresReenrollmentRequest KeyfactorApiModelsCertificateStoresReenrollmentRequest
...
func (o *KeyfactorApiModelsCertificateStoresReenrollmentRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsCertificateStoresReenrollmentRequest := _KeyfactorApiModelsCertificateStoresReenrollmentRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsCertificateStoresReenrollmentRequest); err == nil {
		*o = KeyfactorApiModelsCertificateStoresReenrollmentRequest(varKeyfactorApiModelsCertificateStoresReenrollmentRequest)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "KeystoreId")
		delete(additionalProperties, "SubjectName")
		delete(additionalProperties, "AgentGuid")
