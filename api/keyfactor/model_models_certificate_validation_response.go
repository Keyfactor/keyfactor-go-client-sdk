...
type _ModelsCertificateValidationResponse ModelsCertificateValidationResponse
...
func (o *ModelsCertificateValidationResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateValidationResponse := _ModelsCertificateValidationResponse{}

	if err = json.Unmarshal(bytes, &varModelsCertificateValidationResponse); err == nil {
		*o = ModelsCertificateValidationResponse(varModelsCertificateValidationResponse)
	}
