...
type _ModelsQueryModelsPagedScanJobPartsQuery ModelsQueryModelsPagedScanJobPartsQuery
...
func (o *ModelsQueryModelsPagedScanJobPartsQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedScanJobPartsQuery := _ModelsQueryModelsPagedScanJobPartsQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedScanJobPartsQuery); err == nil {
		*o = ModelsQueryModelsPagedScanJobPartsQuery(varModelsQueryModelsPagedScanJobPartsQuery)
	}
