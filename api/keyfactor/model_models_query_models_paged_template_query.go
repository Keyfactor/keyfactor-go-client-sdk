...
// checks if the ModelsQueryModelsPagedTemplateQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedTemplateQuery{}
...
type _ModelsQueryModelsPagedTemplateQuery ModelsQueryModelsPagedTemplateQuery
...
func NewModelsQueryModelsPagedTemplateQuery() *ModelsQueryModelsPagedTemplateQuery {
	this := ModelsQueryModelsPagedTemplateQuery{}
	return &this
}
...
func (o *ModelsQueryModelsPagedTemplateQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedTemplateQuery := _ModelsQueryModelsPagedTemplateQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedTemplateQuery); err == nil {
		*o = ModelsQueryModelsPagedTemplateQuery(varModelsQueryModelsPagedTemplateQuery)
	}
...
type NullableModelsQueryModelsPagedTemplateQuery struct {
	value *ModelsQueryModelsPagedTemplateQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedTemplateQuery) Get() *ModelsQueryModelsPagedTemplateQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedTemplateQuery) Set(val *ModelsQueryModelsPagedTemplateQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedTemplateQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedTemplateQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedTemplateQuery(val *ModelsQueryModelsPagedTemplateQuery) *NullableModelsQueryModelsPagedTemplateQuery {
	return &NullableModelsQueryModelsPagedTemplateQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedTemplateQuery) MarshalJSON() ([]byte, error) {
