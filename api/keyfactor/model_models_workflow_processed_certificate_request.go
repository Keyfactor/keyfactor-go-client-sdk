...
type _ModelsWorkflowProcessedCertificateRequest ModelsWorkflowProcessedCertificateRequest
...
func (o *ModelsWorkflowProcessedCertificateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsWorkflowProcessedCertificateRequest := _ModelsWorkflowProcessedCertificateRequest{}

	if err = json.Unmarshal(bytes, &varModelsWorkflowProcessedCertificateRequest); err == nil {
		*o = ModelsWorkflowProcessedCertificateRequest(varModelsWorkflowProcessedCertificateRequest)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "CARowId")
		delete(additionalProperties, "CARequestId")
		delete(additionalProperties, "CAHost")
		delete(additionalProperties, "CALogicalName")
