...
type _ModelsSSHServerGroupsServerGroupResponse ModelsSSHServerGroupsServerGroupResponse
...
func (o *ModelsSSHServerGroupsServerGroupResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSHServerGroupsServerGroupResponse := _ModelsSSHServerGroupsServerGroupResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSHServerGroupsServerGroupResponse); err == nil {
		*o = ModelsSSHServerGroupsServerGroupResponse(varModelsSSHServerGroupsServerGroupResponse)
	}
