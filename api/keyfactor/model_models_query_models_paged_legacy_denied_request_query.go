...
// checks if the ModelsQueryModelsPagedLegacyDeniedRequestQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedLegacyDeniedRequestQuery{}
...
type _ModelsQueryModelsPagedLegacyDeniedRequestQuery ModelsQueryModelsPagedLegacyDeniedRequestQuery
...
func (o ModelsQueryModelsPagedLegacyDeniedRequestQuery) MarshalJSON() ([]byte, error) {
...
func (o *ModelsQueryModelsPagedLegacyDeniedRequestQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedLegacyDeniedRequestQuery := _ModelsQueryModelsPagedLegacyDeniedRequestQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedLegacyDeniedRequestQuery); err == nil {
		*o = ModelsQueryModelsPagedLegacyDeniedRequestQuery(varModelsQueryModelsPagedLegacyDeniedRequestQuery)
	}
...
type NullableModelsQueryModelsPagedLegacyDeniedRequestQuery struct {
	value *ModelsQueryModelsPagedLegacyDeniedRequestQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedLegacyDeniedRequestQuery) Get() *ModelsQueryModelsPagedLegacyDeniedRequestQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedLegacyDeniedRequestQuery) Set(val *ModelsQueryModelsPagedLegacyDeniedRequestQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedLegacyDeniedRequestQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedLegacyDeniedRequestQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedLegacyDeniedRequestQuery(val *ModelsQueryModelsPagedLegacyDeniedRequestQuery) *NullableModelsQueryModelsPagedLegacyDeniedRequestQuery {
	return &NullableModelsQueryModelsPagedLegacyDeniedRequestQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedLegacyDeniedRequestQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedLegacyDeniedRequestQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
