...
// checks if the ModelsQueryModelsPagedPendingAlertQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedPendingAlertQuery{}
...
type _ModelsQueryModelsPagedPendingAlertQuery ModelsQueryModelsPagedPendingAlertQuery
...
func (o *ModelsQueryModelsPagedPendingAlertQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedPendingAlertQuery := _ModelsQueryModelsPagedPendingAlertQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedPendingAlertQuery); err == nil {
		*o = ModelsQueryModelsPagedPendingAlertQuery(varModelsQueryModelsPagedPendingAlertQuery)
	}
...
type NullableModelsQueryModelsPagedPendingAlertQuery struct {
	value *ModelsQueryModelsPagedPendingAlertQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedPendingAlertQuery) Get() *ModelsQueryModelsPagedPendingAlertQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedPendingAlertQuery) Set(val *ModelsQueryModelsPagedPendingAlertQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedPendingAlertQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedPendingAlertQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedPendingAlertQuery(val *ModelsQueryModelsPagedPendingAlertQuery) *NullableModelsQueryModelsPagedPendingAlertQuery {
	return &NullableModelsQueryModelsPagedPendingAlertQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedPendingAlertQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsQueryModelsPagedPendingAlertQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
