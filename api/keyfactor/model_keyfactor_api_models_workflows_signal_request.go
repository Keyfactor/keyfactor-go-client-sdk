...
type _KeyfactorApiModelsWorkflowsSignalRequest KeyfactorApiModelsWorkflowsSignalRequest
...
func (o *KeyfactorApiModelsWorkflowsSignalRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsSignalRequest := _KeyfactorApiModelsWorkflowsSignalRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsSignalRequest); err == nil {
		*o = KeyfactorApiModelsWorkflowsSignalRequest(varKeyfactorApiModelsWorkflowsSignalRequest)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "SignalKey")
