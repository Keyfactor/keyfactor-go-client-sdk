...
func (o *KeyfactorApiModelsWorkflowsInstanceQueryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsInstanceQueryResponse := _KeyfactorApiModelsWorkflowsInstanceQueryResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsInstanceQueryResponse); err == nil {
		*o = KeyfactorApiModelsWorkflowsInstanceQueryResponse(varKeyfactorApiModelsWorkflowsInstanceQueryResponse)
	}
