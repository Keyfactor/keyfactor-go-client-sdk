...
func (o *ModelsReportSchedule) UnmarshalJSON(bytes []byte) (err error) {
	varModelsReportSchedule := _ModelsReportSchedule{}

	if err = json.Unmarshal(bytes, &varModelsReportSchedule); err == nil {
		*o = ModelsReportSchedule(varModelsReportSchedule)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "SendReport")
		delete(additionalProperties, "SaveReport")
		delete(additionalProperties, "SaveReportPath")
		delete(additionalProperties, "ReportFormat")
		delete(additionalProperties, "KeyfactorSchedule")
		delete(additionalProperties, "CertificateCollectionId")
		delete(additionalProperties, "EmailRecipients")
		delete(additionalProperties, "RuntimeParameters")
