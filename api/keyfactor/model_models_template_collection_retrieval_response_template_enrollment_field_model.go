...
// checks if the ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel{}
...
type _ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel
...
func (o ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) MarshalJSON() ([]byte, error) {
...
func (o ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) ToMap() (map[string]interface{}, error) {
...
func (o *ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel := _ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel{}

	if err = json.Unmarshal(bytes, &varModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel); err == nil {
		*o = ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel(varModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel)
	}
...
type NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel struct {
	value *ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel
	isSet bool
}

func (v NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) Get() *ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel {
	return v.value
}

func (v *NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) Set(val *ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel(val *ModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) *NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel {
	return &NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel{value: val, isSet: true}
}

func (v NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsTemplateCollectionRetrievalResponseTemplateEnrollmentFieldModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
