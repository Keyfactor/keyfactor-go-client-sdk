...
type _ModelsSSLEndpointHistoryResponse ModelsSSLEndpointHistoryResponse
...
func (o *ModelsSSLEndpointHistoryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLEndpointHistoryResponse := _ModelsSSLEndpointHistoryResponse{}

	if err = json.Unmarshal(bytes, &varModelsSSLEndpointHistoryResponse); err == nil {
		*o = ModelsSSLEndpointHistoryResponse(varModelsSSLEndpointHistoryResponse)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "HistoryId")
		delete(additionalProperties, "EndpointId")
		delete(additionalProperties, "AuditId")
		delete(additionalProperties, "Timestamp")
		delete(additionalProperties, "Status")
		delete(additionalProperties, "JobType")
		delete(additionalProperties, "ProbeType")
		delete(additionalProperties, "ReverseDNS")
		delete(additionalProperties, "HistoryCertificates")
