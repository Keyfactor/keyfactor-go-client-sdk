...
type _ModelsRevocationSuspendedRevocationResponse ModelsRevocationSuspendedRevocationResponse
...
func (o *ModelsRevocationSuspendedRevocationResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsRevocationSuspendedRevocationResponse := _ModelsRevocationSuspendedRevocationResponse{}

	if err = json.Unmarshal(bytes, &varModelsRevocationSuspendedRevocationResponse); err == nil {
		*o = ModelsRevocationSuspendedRevocationResponse(varModelsRevocationSuspendedRevocationResponse)
	}
