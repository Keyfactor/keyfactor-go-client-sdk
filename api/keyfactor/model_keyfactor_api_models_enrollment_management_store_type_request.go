...
type _KeyfactorApiModelsEnrollmentManagementStoreTypeRequest KeyfactorApiModelsEnrollmentManagementStoreTypeRequest
...
func (o *KeyfactorApiModelsEnrollmentManagementStoreTypeRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsEnrollmentManagementStoreTypeRequest := _KeyfactorApiModelsEnrollmentManagementStoreTypeRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsEnrollmentManagementStoreTypeRequest); err == nil {
		*o = KeyfactorApiModelsEnrollmentManagementStoreTypeRequest(varKeyfactorApiModelsEnrollmentManagementStoreTypeRequest)
	}
