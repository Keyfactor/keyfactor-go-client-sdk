...
type _KeyfactorApiModelsAlertsPendingPendingAlertResponse KeyfactorApiModelsAlertsPendingPendingAlertResponse
...
func (o *KeyfactorApiModelsAlertsPendingPendingAlertResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsPendingPendingAlertResponse := _KeyfactorApiModelsAlertsPendingPendingAlertResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsPendingPendingAlertResponse); err == nil {
		*o = KeyfactorApiModelsAlertsPendingPendingAlertResponse(varKeyfactorApiModelsAlertsPendingPendingAlertResponse)
	}
