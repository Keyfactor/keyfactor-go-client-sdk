...
type _ModelsCSRContents ModelsCSRContents
...
func (o *ModelsCSRContents) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCSRContents := _ModelsCSRContents{}

	if err = json.Unmarshal(bytes, &varModelsCSRContents); err == nil {
		*o = ModelsCSRContents(varModelsCSRContents)
	}
