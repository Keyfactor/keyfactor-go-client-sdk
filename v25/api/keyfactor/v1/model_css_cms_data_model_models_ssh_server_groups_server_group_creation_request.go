...
// checks if the CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest{}
...
func (o CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest struct {
	value *CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest
	isSet bool
}

func (v NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) Get() *CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) Set(val *CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest(val *CSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) *NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest {
	return &NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsSSHServerGroupsServerGroupCreationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
