...
`func NewPAMLocalLocalPAMEntryUpdateRequest(secretName string, ) *PAMLocalLocalPAMEntryUpdateRequest`
...
`func (o *PAMLocalLocalPAMEntryUpdateRequest) HasSecretValue() bool`

HasSecretValue returns a boolean if a field has been set.

### SetSecretValueNil

`func (o *PAMLocalLocalPAMEntryUpdateRequest) SetSecretValueNil(b bool)`

 SetSecretValueNil sets the value for SecretValue to be an explicit nil

### UnsetSecretValue
`func (o *PAMLocalLocalPAMEntryUpdateRequest) UnsetSecretValue()`
