...
`func (o *CSSCMSDataModelModelsReport) GetCustomURL() string`

GetCustomURL returns the CustomURL field if non-nil, zero value otherwise.

### GetCustomURLOk

`func (o *CSSCMSDataModelModelsReport) GetCustomURLOk() (*string, bool)`
...
`func (o *CSSCMSDataModelModelsReport) SetUserDefined(v bool)`

SetUserDefined sets UserDefined field to given value.

### HasUserDefined

`func (o *CSSCMSDataModelModelsReport) HasUserDefined() bool`
