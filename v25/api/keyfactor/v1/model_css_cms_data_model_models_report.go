...
// checks if the CSSCMSDataModelModelsReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsReport{}
...
func NewCSSCMSDataModelModelsReport() *CSSCMSDataModelModelsReport {
	this := CSSCMSDataModelModelsReport{}
	return &this
}
...
func (o *CSSCMSDataModelModelsReport) SetCustomURLNil() {
	o.CustomURL.Set(nil)
}
...
func (o *CSSCMSDataModelModelsReport) GetReportParameter() []CSSCMSDataModelModelsReportParameters {
	if o == nil {
		var ret []CSSCMSDataModelModelsReportParameters
		return ret
	}
...
func (o *CSSCMSDataModelModelsReport) GetSchedules() []CSSCMSDataModelModelsReportSchedule {
	if o == nil {
		var ret []CSSCMSDataModelModelsReportSchedule
		return ret
	}
	return o.Schedules
}
...
type NullableCSSCMSDataModelModelsReport struct {
	value *CSSCMSDataModelModelsReport
	isSet bool
}

func (v NullableCSSCMSDataModelModelsReport) Get() *CSSCMSDataModelModelsReport {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsReport) Set(val *CSSCMSDataModelModelsReport) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsReport) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsReport(val *CSSCMSDataModelModelsReport) *NullableCSSCMSDataModelModelsReport {
	return &NullableCSSCMSDataModelModelsReport{value: val, isSet: true}
}
