...
func (o *CSSCMSDataModelModelsKeyfactorSecret) GetSecretType() CSSCMSDataModelEnumsSecretType {
	if o == nil || isNil(o.SecretType) {
		var ret CSSCMSDataModelEnumsSecretType
		return ret
	}
	return *o.SecretType
}
...
func (o *CSSCMSDataModelModelsKeyfactorSecret) GetRemoteProviderName() string {
	if o == nil || isNil(o.RemoteProviderName.Get()) {
		var ret string
		return ret
	}
	return *o.RemoteProviderName.Get()
}

// GetRemoteProviderNameOk returns a tuple with the RemoteProviderName field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CSSCMSDataModelModelsKeyfactorSecret) GetRemoteProviderNameOk() (*string, bool) {
	...
	return o.RemoteProviderName.Get(), o.RemoteProviderName.IsSet()
}
...
func (o *CSSCMSDataModelModelsKeyfactorSecret) HasRemoteProviderName() bool {
	if o != nil && o.RemoteProviderName.IsSet() {
		return true
	}
...
func (o *CSSCMSDataModelModelsKeyfactorSecret) GetDoesHaveValue() bool {
	if o == nil || isNil(o.DoesHaveValue) {
		var ret bool
		return ret
	}
	return *o.DoesHaveValue
}

// GetDoesHaveValueOk returns a tuple with the DoesHaveValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CSSCMSDataModelModelsKeyfactorSecret) GetDoesHaveValueOk() (*bool, bool) {
	if o == nil || isNil(o.DoesHaveValue) {
		return nil, false
	}
	return o.DoesHaveValue, true
}
...
func (o CSSCMSDataModelModelsKeyfactorSecret) ToMap() (map[string]interface{}, error) {
	...
	if o.RemoteProviderName.IsSet() {
		toSerialize["RemoteProviderName"] = o.RemoteProviderName.Get()
	}
