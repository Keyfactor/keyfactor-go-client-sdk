...
// checks if the AlertsDeniedDeniedAlertUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertsDeniedDeniedAlertUpdateRequest{}
...
func NewAlertsDeniedDeniedAlertUpdateRequest(displayName string, subject string, message string) *AlertsDeniedDeniedAlertUpdateRequest {
	this := AlertsDeniedDeniedAlertUpdateRequest{}
...
func (o *AlertsDeniedDeniedAlertUpdateRequest) SetFriendlyNameNil() {
...
type NullableAlertsDeniedDeniedAlertUpdateRequest struct {
	value *AlertsDeniedDeniedAlertUpdateRequest
	isSet bool
}

func (v NullableAlertsDeniedDeniedAlertUpdateRequest) Get() *AlertsDeniedDeniedAlertUpdateRequest {
	return v.value
}

func (v *NullableAlertsDeniedDeniedAlertUpdateRequest) Set(val *AlertsDeniedDeniedAlertUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertsDeniedDeniedAlertUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertsDeniedDeniedAlertUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertsDeniedDeniedAlertUpdateRequest(val *AlertsDeniedDeniedAlertUpdateRequest) *NullableAlertsDeniedDeniedAlertUpdateRequest {
	return &NullableAlertsDeniedDeniedAlertUpdateRequest{value: val, isSet: true}
}

func (v NullableAlertsDeniedDeniedAlertUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertsDeniedDeniedAlertUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
