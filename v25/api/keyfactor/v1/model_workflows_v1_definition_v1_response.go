...
// checks if the WorkflowsV1DefinitionV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowsV1DefinitionV1Response{}

// WorkflowsV1DefinitionV1Response struct for WorkflowsV1DefinitionV1Response
type WorkflowsV1DefinitionV1Response struct {
	...
	Steps            []WorkflowsV1DefinitionStepV1Response `json:"Steps,omitempty"`
...
func NewWorkflowsV1DefinitionV1Response() *WorkflowsV1DefinitionV1Response {
	this := WorkflowsV1DefinitionV1Response{}
	return &this
}
...
func (o *WorkflowsV1DefinitionV1Response) SetDisplayNameNil() {
...
func (o *WorkflowsV1DefinitionV1Response) SetDescriptionNil() {
...
func (o *WorkflowsV1DefinitionV1Response) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *WorkflowsV1DefinitionV1Response) SetKeyDisplayNameNil() {
...
func (o *WorkflowsV1DefinitionV1Response) SetWorkflowTypeNil() {
...
func (o *WorkflowsV1DefinitionV1Response) GetSteps() []WorkflowsV1DefinitionStepV1Response {
	if o == nil {
		var ret []WorkflowsV1DefinitionStepV1Response
		return ret
	}
	return o.Steps
}
...
// SetSteps gets a reference to the given []WorkflowsV1DefinitionStepV1Response and assigns it to the Steps field.
...
func (o *WorkflowsV1DefinitionV1Response) SetPublishedVersionNil() {
...
func (o WorkflowsV1DefinitionV1Response) MarshalJSON() ([]byte, error) {
...
func (o WorkflowsV1DefinitionV1Response) ToMap() (map[string]interface{}, error) {
...
type NullableWorkflowsV1DefinitionV1Response struct {
	value *WorkflowsV1DefinitionV1Response
	isSet bool
}

func (v NullableWorkflowsV1DefinitionV1Response) Get() *WorkflowsV1DefinitionV1Response {
	return v.value
}

func (v *NullableWorkflowsV1DefinitionV1Response) Set(val *WorkflowsV1DefinitionV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowsV1DefinitionV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowsV1DefinitionV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowsV1DefinitionV1Response(val *WorkflowsV1DefinitionV1Response) *NullableWorkflowsV1DefinitionV1Response {
	return &NullableWorkflowsV1DefinitionV1Response{value: val, isSet: true}
}

func (v NullableWorkflowsV1DefinitionV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowsV1DefinitionV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
