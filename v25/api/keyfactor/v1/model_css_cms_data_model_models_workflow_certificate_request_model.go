...
// checks if the CSSCMSDataModelModelsWorkflowCertificateRequestModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsWorkflowCertificateRequestModel{}
...
func NewCSSCMSDataModelModelsWorkflowCertificateRequestModel() *CSSCMSDataModelModelsWorkflowCertificateRequestModel {
	this := CSSCMSDataModelModelsWorkflowCertificateRequestModel{}
	return &this
}
...
func (o *CSSCMSDataModelModelsWorkflowCertificateRequestModel) SetCARequestIdNil() {
...
func (o *CSSCMSDataModelModelsWorkflowCertificateRequestModel) SetCommonNameNil() {
...
func (o *CSSCMSDataModelModelsWorkflowCertificateRequestModel) SetTemplateNil() {
	o.Template.Set(nil)
}
...
func (o *CSSCMSDataModelModelsWorkflowCertificateRequestModel) SetStateStringNil() {
...
func (o CSSCMSDataModelModelsWorkflowCertificateRequestModel) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsWorkflowCertificateRequestModel) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel struct {
	value *CSSCMSDataModelModelsWorkflowCertificateRequestModel
	isSet bool
}

func (v NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel) Get() *CSSCMSDataModelModelsWorkflowCertificateRequestModel {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel) Set(val *CSSCMSDataModelModelsWorkflowCertificateRequestModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsWorkflowCertificateRequestModel(val *CSSCMSDataModelModelsWorkflowCertificateRequestModel) *NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel {
	return &NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsWorkflowCertificateRequestModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
