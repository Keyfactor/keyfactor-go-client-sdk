...
// checks if the CertificatesOwnerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificatesOwnerRequest{}
...
// NewCertificatesOwnerRequest instantiates a new CertificatesOwnerRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCertificatesOwnerRequest() *CertificatesOwnerRequest {
	this := CertificatesOwnerRequest{}
	return &this
}

// NewCertificatesOwnerRequestWithDefaults instantiates a new CertificatesOwnerRequest object
...
type NullableCertificatesOwnerRequest struct {
	value *CertificatesOwnerRequest
	isSet bool
}

func (v NullableCertificatesOwnerRequest) Get() *CertificatesOwnerRequest {
	return v.value
}

func (v *NullableCertificatesOwnerRequest) Set(val *CertificatesOwnerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificatesOwnerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificatesOwnerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificatesOwnerRequest(val *CertificatesOwnerRequest) *NullableCertificatesOwnerRequest {
	return &NullableCertificatesOwnerRequest{value: val, isSet: true}
}
