...
// checks if the CSSCMSDataModelModelsCertificateDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsCertificateDetails{}
...
type NullableCSSCMSDataModelModelsCertificateDetails struct {
	value *CSSCMSDataModelModelsCertificateDetails
	isSet bool
}

func (v NullableCSSCMSDataModelModelsCertificateDetails) Get() *CSSCMSDataModelModelsCertificateDetails {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsCertificateDetails) Set(val *CSSCMSDataModelModelsCertificateDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsCertificateDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsCertificateDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsCertificateDetails(val *CSSCMSDataModelModelsCertificateDetails) *NullableCSSCMSDataModelModelsCertificateDetails {
	return &NullableCSSCMSDataModelModelsCertificateDetails{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsCertificateDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsCertificateDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
