...
// checks if the PermissionSetsPermissionSetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionSetsPermissionSetResponse{}
...
func NewPermissionSetsPermissionSetResponse() *PermissionSetsPermissionSetResponse {
	this := PermissionSetsPermissionSetResponse{}
	return &this
}
...
type NullablePermissionSetsPermissionSetResponse struct {
	value *PermissionSetsPermissionSetResponse
	isSet bool
}

func (v NullablePermissionSetsPermissionSetResponse) Get() *PermissionSetsPermissionSetResponse {
	return v.value
}

func (v *NullablePermissionSetsPermissionSetResponse) Set(val *PermissionSetsPermissionSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionSetsPermissionSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionSetsPermissionSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionSetsPermissionSetResponse(val *PermissionSetsPermissionSetResponse) *NullablePermissionSetsPermissionSetResponse {
	return &NullablePermissionSetsPermissionSetResponse{value: val, isSet: true}
}

func (v NullablePermissionSetsPermissionSetResponse) MarshalJSON() ([]byte, error) {
