...
// checks if the AlertsExpirationExpirationAlertTestAllRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertsExpirationExpirationAlertTestAllRequest{}
...
// NewAlertsExpirationExpirationAlertTestAllRequest instantiates a new AlertsExpirationExpirationAlertTestAllRequest object
...
func NewAlertsExpirationExpirationAlertTestAllRequest() *AlertsExpirationExpirationAlertTestAllRequest {
	this := AlertsExpirationExpirationAlertTestAllRequest{}
	return &this
}

// NewAlertsExpirationExpirationAlertTestAllRequestWithDefaults instantiates a new AlertsExpirationExpirationAlertTestAllRequest object
...
func (o *AlertsExpirationExpirationAlertTestAllRequest) GetEvaluationDate() time.Time {
...
func (o *AlertsExpirationExpirationAlertTestAllRequest) SetEvaluationDate(v time.Time) {
	o.EvaluationDate = &v
}
...
func (o *AlertsExpirationExpirationAlertTestAllRequest) GetSendAlerts() bool {
...
func (o *AlertsExpirationExpirationAlertTestAllRequest) HasSendAlerts() bool {
	if o != nil && !isNil(o.SendAlerts) {
		return true
	}
...
func (o *AlertsExpirationExpirationAlertTestAllRequest) SetSendAlerts(v bool) {
	o.SendAlerts = &v
}

func (o AlertsExpirationExpirationAlertTestAllRequest) MarshalJSON() ([]byte, error) {
...
type NullableAlertsExpirationExpirationAlertTestAllRequest struct {
	value *AlertsExpirationExpirationAlertTestAllRequest
	isSet bool
}

func (v NullableAlertsExpirationExpirationAlertTestAllRequest) Get() *AlertsExpirationExpirationAlertTestAllRequest {
	return v.value
}

func (v *NullableAlertsExpirationExpirationAlertTestAllRequest) Set(val *AlertsExpirationExpirationAlertTestAllRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertsExpirationExpirationAlertTestAllRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertsExpirationExpirationAlertTestAllRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertsExpirationExpirationAlertTestAllRequest(val *AlertsExpirationExpirationAlertTestAllRequest) *NullableAlertsExpirationExpirationAlertTestAllRequest {
	return &NullableAlertsExpirationExpirationAlertTestAllRequest{value: val, isSet: true}
}

func (v NullableAlertsExpirationExpirationAlertTestAllRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertsExpirationExpirationAlertTestAllRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
