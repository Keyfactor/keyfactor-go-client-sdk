...
// checks if the CertificateStoreContainersApplicationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateStoreContainersApplicationResponse{}

// CertificateStoreContainersApplicationResponse struct for CertificateStoreContainersApplicationResponse
type CertificateStoreContainersApplicationResponse struct {
	Id                *int32                                                 `json:"Id,omitempty"`
	Name              NullableString                                         `json:"Name,omitempty"`
	Schedule          *KeyfactorCommonSchedulingKeyfactorSchedule            `json:"Schedule,omitempty"`
	CertificateStores []CertificateStoresCertificateStoreApplicationResponse `json:"CertificateStores,omitempty"`
}
...
func NewCertificateStoreContainersApplicationResponse() *CertificateStoreContainersApplicationResponse {
	this := CertificateStoreContainersApplicationResponse{}
	return &this
}
...
func (o *CertificateStoreContainersApplicationResponse) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *CertificateStoreContainersApplicationResponse) GetCertificateStores() []CertificateStoresCertificateStoreApplicationResponse {
	if o == nil {
		var ret []CertificateStoresCertificateStoreApplicationResponse
		return ret
	}
...
// SetCertificateStores gets a reference to the given []CertificateStoresCertificateStoreApplicationResponse and assigns it to the CertificateStores field.
...
func (o CertificateStoreContainersApplicationResponse) MarshalJSON() ([]byte, error) {
...
func (o CertificateStoreContainersApplicationResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCertificateStoreContainersApplicationResponse struct {
	value *CertificateStoreContainersApplicationResponse
	isSet bool
}

func (v NullableCertificateStoreContainersApplicationResponse) Get() *CertificateStoreContainersApplicationResponse {
	return v.value
}

func (v *NullableCertificateStoreContainersApplicationResponse) Set(val *CertificateStoreContainersApplicationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateStoreContainersApplicationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateStoreContainersApplicationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateStoreContainersApplicationResponse(val *CertificateStoreContainersApplicationResponse) *NullableCertificateStoreContainersApplicationResponse {
	return &NullableCertificateStoreContainersApplicationResponse{value: val, isSet: true}
}

func (v NullableCertificateStoreContainersApplicationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateStoreContainersApplicationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
