...
// checks if the ReportsReportSchedulesReportScheduleUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportsReportSchedulesReportScheduleUpdateRequest{}
...
func NewReportsReportSchedulesReportScheduleUpdateRequest(id int32, reportFormat string, runtimeParameters map[string]string) *ReportsReportSchedulesReportScheduleUpdateRequest {
	this := ReportsReportSchedulesReportScheduleUpdateRequest{}
	this.Id = id
...
func (o ReportsReportSchedulesReportScheduleUpdateRequest) MarshalJSON() ([]byte, error) {
...
type NullableReportsReportSchedulesReportScheduleUpdateRequest struct {
	value *ReportsReportSchedulesReportScheduleUpdateRequest
	isSet bool
}

func (v NullableReportsReportSchedulesReportScheduleUpdateRequest) Get() *ReportsReportSchedulesReportScheduleUpdateRequest {
	return v.value
}

func (v *NullableReportsReportSchedulesReportScheduleUpdateRequest) Set(val *ReportsReportSchedulesReportScheduleUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReportsReportSchedulesReportScheduleUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReportsReportSchedulesReportScheduleUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportsReportSchedulesReportScheduleUpdateRequest(val *ReportsReportSchedulesReportScheduleUpdateRequest) *NullableReportsReportSchedulesReportScheduleUpdateRequest {
	return &NullableReportsReportSchedulesReportScheduleUpdateRequest{value: val, isSet: true}
}

func (v NullableReportsReportSchedulesReportScheduleUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportsReportSchedulesReportScheduleUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
