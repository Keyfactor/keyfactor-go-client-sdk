...
func (r ApiCreateEnrollmentRenewRequest) EnrollmentRenewAPIRequest(enrollmentRenewAPIRequest EnrollmentRenewAPIRequest) ApiCreateEnrollmentRenewRequest {
	r.enrollmentRenewAPIRequest = &enrollmentRenewAPIRequest
	return r
}
