...
// checks if the MetadataFieldMetadataFieldResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataFieldMetadataFieldResponse{}
...
func NewMetadataFieldMetadataFieldResponse() *MetadataFieldMetadataFieldResponse {
	this := MetadataFieldMetadataFieldResponse{}
	return &this
}
...
type NullableMetadataFieldMetadataFieldResponse struct {
	value *MetadataFieldMetadataFieldResponse
	isSet bool
}

func (v NullableMetadataFieldMetadataFieldResponse) Get() *MetadataFieldMetadataFieldResponse {
	return v.value
}

func (v *NullableMetadataFieldMetadataFieldResponse) Set(val *MetadataFieldMetadataFieldResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataFieldMetadataFieldResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataFieldMetadataFieldResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataFieldMetadataFieldResponse(val *MetadataFieldMetadataFieldResponse) *NullableMetadataFieldMetadataFieldResponse {
	return &NullableMetadataFieldMetadataFieldResponse{value: val, isSet: true}
}

func (v NullableMetadataFieldMetadataFieldResponse) MarshalJSON() ([]byte, error) {
