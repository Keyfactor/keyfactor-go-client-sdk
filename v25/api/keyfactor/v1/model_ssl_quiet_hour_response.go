...
// checks if the SslQuietHourResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SslQuietHourResponse{}
...
type NullableSslQuietHourResponse struct {
	value *SslQuietHourResponse
	isSet bool
}

func (v NullableSslQuietHourResponse) Get() *SslQuietHourResponse {
	return v.value
}

func (v *NullableSslQuietHourResponse) Set(val *SslQuietHourResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSslQuietHourResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableSslQuietHourResponse(val *SslQuietHourResponse) *NullableSslQuietHourResponse {
	return &NullableSslQuietHourResponse{value: val, isSet: true}
}
