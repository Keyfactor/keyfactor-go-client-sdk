...
// checks if the EnrollmentPatternsEnrollmentPatternMetadataFieldResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnrollmentPatternsEnrollmentPatternMetadataFieldResponse{}

// EnrollmentPatternsEnrollmentPatternMetadataFieldResponse struct for EnrollmentPatternsEnrollmentPatternMetadataFieldResponse
type EnrollmentPatternsEnrollmentPatternMetadataFieldResponse struct {
...
func NewEnrollmentPatternsEnrollmentPatternMetadataFieldResponse() *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse {
	this := EnrollmentPatternsEnrollmentPatternMetadataFieldResponse{}
	return &this
}
...
func (o *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) SetDefaultValueNil() {
...
func (o *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) SetValidationNil() {
...
func (o *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) MarshalJSON() ([]byte, error) {
...
func (o EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse struct {
	value *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse
	isSet bool
}

func (v NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse) Get() *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse {
	return v.value
}

func (v *NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse) Set(val *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse(val *EnrollmentPatternsEnrollmentPatternMetadataFieldResponse) *NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse {
	return &NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse{value: val, isSet: true}
}

func (v NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnrollmentPatternsEnrollmentPatternMetadataFieldResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
