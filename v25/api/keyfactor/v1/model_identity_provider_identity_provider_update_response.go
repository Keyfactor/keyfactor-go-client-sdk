...
// checks if the IdentityProviderIdentityProviderUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderIdentityProviderUpdateResponse{}
...
func NewIdentityProviderIdentityProviderUpdateResponse() *IdentityProviderIdentityProviderUpdateResponse {
	this := IdentityProviderIdentityProviderUpdateResponse{}
	return &this
}
...
func (o IdentityProviderIdentityProviderUpdateResponse) MarshalJSON() ([]byte, error) {
...
type NullableIdentityProviderIdentityProviderUpdateResponse struct {
	value *IdentityProviderIdentityProviderUpdateResponse
	isSet bool
}

func (v NullableIdentityProviderIdentityProviderUpdateResponse) Get() *IdentityProviderIdentityProviderUpdateResponse {
	return v.value
}

func (v *NullableIdentityProviderIdentityProviderUpdateResponse) Set(val *IdentityProviderIdentityProviderUpdateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderIdentityProviderUpdateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderIdentityProviderUpdateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderIdentityProviderUpdateResponse(val *IdentityProviderIdentityProviderUpdateResponse) *NullableIdentityProviderIdentityProviderUpdateResponse {
	return &NullableIdentityProviderIdentityProviderUpdateResponse{value: val, isSet: true}
}

func (v NullableIdentityProviderIdentityProviderUpdateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderIdentityProviderUpdateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
