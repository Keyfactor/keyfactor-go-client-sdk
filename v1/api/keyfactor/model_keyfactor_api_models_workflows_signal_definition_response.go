...
type _KeyfactorApiModelsWorkflowsSignalDefinitionResponse KeyfactorApiModelsWorkflowsSignalDefinitionResponse
...
func (o *KeyfactorApiModelsWorkflowsSignalDefinitionResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsWorkflowsSignalDefinitionResponse := _KeyfactorApiModelsWorkflowsSignalDefinitionResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsWorkflowsSignalDefinitionResponse); err == nil {
		*o = KeyfactorApiModelsWorkflowsSignalDefinitionResponse(varKeyfactorApiModelsWorkflowsSignalDefinitionResponse)
	}
