...
type _ModelsCertificateStoreUpdateServerRequest ModelsCertificateStoreUpdateServerRequest
...
func (o *ModelsCertificateStoreUpdateServerRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStoreUpdateServerRequest := _ModelsCertificateStoreUpdateServerRequest{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStoreUpdateServerRequest); err == nil {
		*o = ModelsCertificateStoreUpdateServerRequest(varModelsCertificateStoreUpdateServerRequest)
	}
