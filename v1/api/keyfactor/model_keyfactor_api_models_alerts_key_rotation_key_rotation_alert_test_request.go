...
func (o *KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest := _KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest); err == nil {
		*o = KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest(varKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest)
	}
