...
type _KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest
...
func (o *KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest := _KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest); err == nil {
		*o = KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest(varKeyfactorApiModelsMonitoringRevocationMonitoringAlertTestAllRequest)
	}
