...
type _ModelsQueryModelsPagedAgentJobQuery ModelsQueryModelsPagedAgentJobQuery
...
func (o *ModelsQueryModelsPagedAgentJobQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedAgentJobQuery := _ModelsQueryModelsPagedAgentJobQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedAgentJobQuery); err == nil {
		*o = ModelsQueryModelsPagedAgentJobQuery(varModelsQueryModelsPagedAgentJobQuery)
	}
