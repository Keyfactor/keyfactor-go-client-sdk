...
type _ModelsCertificateStoreInventory ModelsCertificateStoreInventory
...
func (o *ModelsCertificateStoreInventory) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateStoreInventory := _ModelsCertificateStoreInventory{}

	if err = json.Unmarshal(bytes, &varModelsCertificateStoreInventory); err == nil {
		*o = ModelsCertificateStoreInventory(varModelsCertificateStoreInventory)
	}
