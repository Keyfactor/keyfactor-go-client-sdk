...
type _ModelsMetadataFieldTypeModel ModelsMetadataFieldTypeModel
...
func (o *ModelsMetadataFieldTypeModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsMetadataFieldTypeModel := _ModelsMetadataFieldTypeModel{}

	if err = json.Unmarshal(bytes, &varModelsMetadataFieldTypeModel); err == nil {
		*o = ModelsMetadataFieldTypeModel(varModelsMetadataFieldTypeModel)
	}
