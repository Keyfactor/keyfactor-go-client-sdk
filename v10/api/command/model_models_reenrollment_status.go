...
type _ModelsReenrollmentStatus ModelsReenrollmentStatus
...
func (o *ModelsReenrollmentStatus) UnmarshalJSON(bytes []byte) (err error) {
	varModelsReenrollmentStatus := _ModelsReenrollmentStatus{}

	if err = json.Unmarshal(bytes, &varModelsReenrollmentStatus); err == nil {
		*o = ModelsReenrollmentStatus(varModelsReenrollmentStatus)
	}
