...
// checks if the ModelsQueryModelsPagedAgentQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsQueryModelsPagedAgentQuery{}
...
type _ModelsQueryModelsPagedAgentQuery ModelsQueryModelsPagedAgentQuery
...
func NewModelsQueryModelsPagedAgentQuery() *ModelsQueryModelsPagedAgentQuery {
	this := ModelsQueryModelsPagedAgentQuery{}
	return &this
}
...
func (o *ModelsQueryModelsPagedAgentQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedAgentQuery := _ModelsQueryModelsPagedAgentQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedAgentQuery); err == nil {
		*o = ModelsQueryModelsPagedAgentQuery(varModelsQueryModelsPagedAgentQuery)
	}
...
type NullableModelsQueryModelsPagedAgentQuery struct {
	value *ModelsQueryModelsPagedAgentQuery
	isSet bool
}

func (v NullableModelsQueryModelsPagedAgentQuery) Get() *ModelsQueryModelsPagedAgentQuery {
	return v.value
}

func (v *NullableModelsQueryModelsPagedAgentQuery) Set(val *ModelsQueryModelsPagedAgentQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsQueryModelsPagedAgentQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsQueryModelsPagedAgentQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsQueryModelsPagedAgentQuery(val *ModelsQueryModelsPagedAgentQuery) *NullableModelsQueryModelsPagedAgentQuery {
	return &NullableModelsQueryModelsPagedAgentQuery{value: val, isSet: true}
}

func (v NullableModelsQueryModelsPagedAgentQuery) MarshalJSON() ([]byte, error) {
