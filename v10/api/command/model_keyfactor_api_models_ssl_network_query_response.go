...
// checks if the KeyfactorApiModelsSslNetworkQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorApiModelsSslNetworkQueryResponse{}
...
func NewKeyfactorApiModelsSslNetworkQueryResponse() *KeyfactorApiModelsSslNetworkQueryResponse {
	this := KeyfactorApiModelsSslNetworkQueryResponse{}
	return &this
}
...
func (o *KeyfactorApiModelsSslNetworkQueryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsSslNetworkQueryResponse := _KeyfactorApiModelsSslNetworkQueryResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsSslNetworkQueryResponse); err == nil {
		*o = KeyfactorApiModelsSslNetworkQueryResponse(varKeyfactorApiModelsSslNetworkQueryResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "DiscoverPercentComplete")
		delete(additionalProperties, "MonitorPercentComplete")
		delete(additionalProperties, "DiscoverStatus")
		delete(additionalProperties, "MonitorStatus")
		delete(additionalProperties, "DiscoverLastScanned")
		delete(additionalProperties, "MonitorLastScanned")
		...
		delete(additionalProperties, "DiscoverJobParts")
		delete(additionalProperties, "MonitorJobParts")
...
type NullableKeyfactorApiModelsSslNetworkQueryResponse struct {
	value *KeyfactorApiModelsSslNetworkQueryResponse
	isSet bool
}

func (v NullableKeyfactorApiModelsSslNetworkQueryResponse) Get() *KeyfactorApiModelsSslNetworkQueryResponse {
	return v.value
}

func (v *NullableKeyfactorApiModelsSslNetworkQueryResponse) Set(val *KeyfactorApiModelsSslNetworkQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorApiModelsSslNetworkQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorApiModelsSslNetworkQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorApiModelsSslNetworkQueryResponse(val *KeyfactorApiModelsSslNetworkQueryResponse) *NullableKeyfactorApiModelsSslNetworkQueryResponse {
	return &NullableKeyfactorApiModelsSslNetworkQueryResponse{value: val, isSet: true}
}

func (v NullableKeyfactorApiModelsSslNetworkQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorApiModelsSslNetworkQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
