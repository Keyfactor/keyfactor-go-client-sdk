...
type _KeyfactorApiModelsSecurityRolesRoleIdentitiesResponse KeyfactorApiModelsSecurityRolesRoleIdentitiesResponse
...
func (o *KeyfactorApiModelsSecurityRolesRoleIdentitiesResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsSecurityRolesRoleIdentitiesResponse := _KeyfactorApiModelsSecurityRolesRoleIdentitiesResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsSecurityRolesRoleIdentitiesResponse); err == nil {
		*o = KeyfactorApiModelsSecurityRolesRoleIdentitiesResponse(varKeyfactorApiModelsSecurityRolesRoleIdentitiesResponse)
	}
