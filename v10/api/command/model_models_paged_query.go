...
// checks if the ModelsPagedQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsPagedQuery{}
...
type _ModelsPagedQuery ModelsPagedQuery
...
func (o *ModelsPagedQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsPagedQuery := _ModelsPagedQuery{}

	if err = json.Unmarshal(bytes, &varModelsPagedQuery); err == nil {
		*o = ModelsPagedQuery(varModelsPagedQuery)
	}
...
type NullableModelsPagedQuery struct {
	value *ModelsPagedQuery
	isSet bool
}

func (v NullableModelsPagedQuery) Get() *ModelsPagedQuery {
	return v.value
}

func (v *NullableModelsPagedQuery) Set(val *ModelsPagedQuery) {
	v.value = val
	v.isSet = true
}
...
func NewNullableModelsPagedQuery(val *ModelsPagedQuery) *NullableModelsPagedQuery {
	return &NullableModelsPagedQuery{value: val, isSet: true}
}
