...
type _ModelsCertificateDownloadRequest ModelsCertificateDownloadRequest
...
func (o *ModelsCertificateDownloadRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateDownloadRequest := _ModelsCertificateDownloadRequest{}

	if err = json.Unmarshal(bytes, &varModelsCertificateDownloadRequest); err == nil {
		*o = ModelsCertificateDownloadRequest(varModelsCertificateDownloadRequest)
	}
