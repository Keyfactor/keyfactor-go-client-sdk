...
type _ModelsTemplateUpdateRequestTemplateEnrollmentFieldModel ModelsTemplateUpdateRequestTemplateEnrollmentFieldModel
...
func (o *ModelsTemplateUpdateRequestTemplateEnrollmentFieldModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateUpdateRequestTemplateEnrollmentFieldModel := _ModelsTemplateUpdateRequestTemplateEnrollmentFieldModel{}

	if err = json.Unmarshal(bytes, &varModelsTemplateUpdateRequestTemplateEnrollmentFieldModel); err == nil {
		*o = ModelsTemplateUpdateRequestTemplateEnrollmentFieldModel(varModelsTemplateUpdateRequestTemplateEnrollmentFieldModel)
	}
