...
type _ModelsQueryModelsPagedSSHLogonQuery ModelsQueryModelsPagedSSHLogonQuery
...
func (o *ModelsQueryModelsPagedSSHLogonQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSSHLogonQuery := _ModelsQueryModelsPagedSSHLogonQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSSHLogonQuery); err == nil {
		*o = ModelsQueryModelsPagedSSHLogonQuery(varModelsQueryModelsPagedSSHLogonQuery)
	}
