...
type _ModelsCertificateRetrievalResponseLocationCountModel ModelsCertificateRetrievalResponseLocationCountModel
...
func (o *ModelsCertificateRetrievalResponseLocationCountModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateRetrievalResponseLocationCountModel := _ModelsCertificateRetrievalResponseLocationCountModel{}

	if err = json.Unmarshal(bytes, &varModelsCertificateRetrievalResponseLocationCountModel); err == nil {
		*o = ModelsCertificateRetrievalResponseLocationCountModel(varModelsCertificateRetrievalResponseLocationCountModel)
	}
