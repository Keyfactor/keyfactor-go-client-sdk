...
type _ModelsTemplateUpdateRequestTemplateRegexModel ModelsTemplateUpdateRequestTemplateRegexModel
...
func (o *ModelsTemplateUpdateRequestTemplateRegexModel) SetTemplateIdNil() {
...
func (o *ModelsTemplateUpdateRequestTemplateRegexModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateUpdateRequestTemplateRegexModel := _ModelsTemplateUpdateRequestTemplateRegexModel{}

	if err = json.Unmarshal(bytes, &varModelsTemplateUpdateRequestTemplateRegexModel); err == nil {
		*o = ModelsTemplateUpdateRequestTemplateRegexModel(varModelsTemplateUpdateRequestTemplateRegexModel)
	}
