...
type _ModelsQueryModelsPagedExpirationAlertQuery ModelsQueryModelsPagedExpirationAlertQuery
...
func (o *ModelsQueryModelsPagedExpirationAlertQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedExpirationAlertQuery := _ModelsQueryModelsPagedExpirationAlertQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedExpirationAlertQuery); err == nil {
		*o = ModelsQueryModelsPagedExpirationAlertQuery(varModelsQueryModelsPagedExpirationAlertQuery)
	}
