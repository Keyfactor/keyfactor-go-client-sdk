...
type _ModelsEnrollmentManagementStoreType ModelsEnrollmentManagementStoreType
...
func (o *ModelsEnrollmentManagementStoreType) UnmarshalJSON(bytes []byte) (err error) {
	varModelsEnrollmentManagementStoreType := _ModelsEnrollmentManagementStoreType{}

	if err = json.Unmarshal(bytes, &varModelsEnrollmentManagementStoreType); err == nil {
		*o = ModelsEnrollmentManagementStoreType(varModelsEnrollmentManagementStoreType)
	}
