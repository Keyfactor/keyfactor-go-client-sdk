...
type _ModelsTemplateRetrievalResponseTemplatePolicyModel ModelsTemplateRetrievalResponseTemplatePolicyModel
...
func (o *ModelsTemplateRetrievalResponseTemplatePolicyModel) UnmarshalJSON(bytes []byte) (err error) {
	varModelsTemplateRetrievalResponseTemplatePolicyModel := _ModelsTemplateRetrievalResponseTemplatePolicyModel{}

	if err = json.Unmarshal(bytes, &varModelsTemplateRetrievalResponseTemplatePolicyModel); err == nil {
		*o = ModelsTemplateRetrievalResponseTemplatePolicyModel(varModelsTemplateRetrievalResponseTemplatePolicyModel)
	}
