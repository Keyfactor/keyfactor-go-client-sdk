...
type ModelsCertificateAuthoritiesCertificateAuthorityResponse struct {
	...
	DenialMax              *int64                                                           `json:"DenialMax,omitempty"`
...
// SetDenialMax gets a reference to the given int64 and assigns it to the DenialMax field.
...
func (o *ModelsCertificateAuthoritiesCertificateAuthorityResponse) UnmarshalJSON(bytes []byte) (err error) {
	varModelsCertificateAuthoritiesCertificateAuthorityResponse := _ModelsCertificateAuthoritiesCertificateAuthorityResponse{}

	if err = json.Unmarshal(bytes, &varModelsCertificateAuthoritiesCertificateAuthorityResponse); err == nil {
		*o = ModelsCertificateAuthoritiesCertificateAuthorityResponse(varModelsCertificateAuthoritiesCertificateAuthorityResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "LogicalName")
		delete(additionalProperties, "HostName")
		delete(additionalProperties, "Delegate")
		delete(additionalProperties, "DelegateEnrollment")
		...
		delete(additionalProperties, "MonitorThresholds")
		delete(additionalProperties, "IssuanceMax")
		delete(additionalProperties, "IssuanceMin")
		delete(additionalProperties, "DenialMax")
		delete(additionalProperties, "FailureMax")
		...
		delete(additionalProperties, "ExplicitCredentials")
		delete(additionalProperties, "SubscriberTerms")
		delete(additionalProperties, "ExplicitUser")
		delete(additionalProperties, "ExplicitPassword")
		delete(additionalProperties, "UseAllowedRequesters")
		delete(additionalProperties, "AllowedRequesters")
		delete(additionalProperties, "FullScan")
		delete(additionalProperties, "IncrementalScan")
		delete(additionalProperties, "ThresholdCheck")
		delete(additionalProperties, "CAType")
		delete(additionalProperties, "AuthCertificate")
		delete(additionalProperties, "EnforceUniqueDN")
