...
type _KeyfactorApiModelsSslQuietHourResponse KeyfactorApiModelsSslQuietHourResponse
...
func (o *KeyfactorApiModelsSslQuietHourResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsSslQuietHourResponse := _KeyfactorApiModelsSslQuietHourResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsSslQuietHourResponse); err == nil {
		*o = KeyfactorApiModelsSslQuietHourResponse(varKeyfactorApiModelsSslQuietHourResponse)
	}
