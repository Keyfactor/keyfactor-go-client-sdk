...
type _KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse
...
func (o *KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse := _KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse); err == nil {
		*o = KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse(varKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse)
	}
