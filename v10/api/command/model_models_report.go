...
func (o *ModelsReport) UnmarshalJSON(bytes []byte) (err error) {
	varModelsReport := _ModelsReport{}

	if err = json.Unmarshal(bytes, &varModelsReport); err == nil {
		*o = ModelsReport(varModelsReport)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ReportPath")
		...
		delete(additionalProperties, "UsesCollection")
		delete(additionalProperties, "ReportParameter")
		delete(additionalProperties, "Schedules")
		delete(additionalProperties, "AcceptedScheduleFormats")
