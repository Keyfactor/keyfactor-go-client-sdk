...
type _KeyfactorApiModelsSslNetworkResponse KeyfactorApiModelsSslNetworkResponse
...
func (o *KeyfactorApiModelsSslNetworkResponse) UnmarshalJSON(bytes []byte) (err error) {
	varKeyfactorApiModelsSslNetworkResponse := _KeyfactorApiModelsSslNetworkResponse{}

	if err = json.Unmarshal(bytes, &varKeyfactorApiModelsSslNetworkResponse); err == nil {
		*o = KeyfactorApiModelsSslNetworkResponse(varKeyfactorApiModelsSslNetworkResponse)
	}
