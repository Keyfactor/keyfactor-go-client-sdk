...
type _ModelsSSLImmediateSslScanRequest ModelsSSLImmediateSslScanRequest
...
func (o *ModelsSSLImmediateSslScanRequest) UnmarshalJSON(bytes []byte) (err error) {
	varModelsSSLImmediateSslScanRequest := _ModelsSSLImmediateSslScanRequest{}

	if err = json.Unmarshal(bytes, &varModelsSSLImmediateSslScanRequest); err == nil {
		*o = ModelsSSLImmediateSslScanRequest(varModelsSSLImmediateSslScanRequest)
	}
