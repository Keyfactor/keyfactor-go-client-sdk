...
type _ModelsQueryModelsPagedSSHServerQuery ModelsQueryModelsPagedSSHServerQuery
...
func (o *ModelsQueryModelsPagedSSHServerQuery) UnmarshalJSON(bytes []byte) (err error) {
	varModelsQueryModelsPagedSSHServerQuery := _ModelsQueryModelsPagedSSHServerQuery{}

	if err = json.Unmarshal(bytes, &varModelsQueryModelsPagedSSHServerQuery); err == nil {
		*o = ModelsQueryModelsPagedSSHServerQuery(varModelsQueryModelsPagedSSHServerQuery)
	}
