...
func (o *ModelsCertificateStoreContainerListResponse) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ModelsCertificateStoreContainerListResponse) SetScheduleNil() {
	o.Schedule.Set(nil)
}
...
func (o *ModelsCertificateStoreContainerListResponse) SetStoreCountNil() {
