...
// checks if the ModelsTemplatesTemplateEnrollmentField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsTemplatesTemplateEnrollmentField{}

// ModelsTemplatesTemplateEnrollmentField struct for ModelsTemplatesTemplateEnrollmentField
type ModelsTemplatesTemplateEnrollmentField struct {
...
func NewModelsTemplatesTemplateEnrollmentField() *ModelsTemplatesTemplateEnrollmentField {
	this := ModelsTemplatesTemplateEnrollmentField{}
	return &this
}
...
func (o *ModelsTemplatesTemplateEnrollmentField) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o ModelsTemplatesTemplateEnrollmentField) MarshalJSON() ([]byte, error) {
...
func (o ModelsTemplatesTemplateEnrollmentField) ToMap() (map[string]interface{}, error) {
...
type NullableModelsTemplatesTemplateEnrollmentField struct {
	value *ModelsTemplatesTemplateEnrollmentField
	isSet bool
}

func (v NullableModelsTemplatesTemplateEnrollmentField) Get() *ModelsTemplatesTemplateEnrollmentField {
	return v.value
}

func (v *NullableModelsTemplatesTemplateEnrollmentField) Set(val *ModelsTemplatesTemplateEnrollmentField) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsTemplatesTemplateEnrollmentField) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsTemplatesTemplateEnrollmentField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsTemplatesTemplateEnrollmentField(val *ModelsTemplatesTemplateEnrollmentField) *NullableModelsTemplatesTemplateEnrollmentField {
	return &NullableModelsTemplatesTemplateEnrollmentField{value: val, isSet: true}
}

func (v NullableModelsTemplatesTemplateEnrollmentField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsTemplatesTemplateEnrollmentField) UnmarshalJSON(src []byte) error {
	v.isSet = true
