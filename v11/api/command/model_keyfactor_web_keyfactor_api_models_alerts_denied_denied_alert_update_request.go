...
// checks if the KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest{}

// KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest struct for KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest
type KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest struct {
...
func NewKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest(displayName string, subject string, message string) *KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest {
	this := KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest{}
...
func (o *KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) SetTemplateIdNil() {
...
func (o KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest struct {
	value *KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) Get() *KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) Set(val *KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest(val *KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) *NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest {
	return &NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
