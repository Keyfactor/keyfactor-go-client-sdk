...
// checks if the KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse{}
...
func NewKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse() *KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse {
	this := KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse struct {
	value *KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) Get() *KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) Set(val *KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse(val *KeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
