...
// checks if the CSSCMSDataModelModelsCertificateStoreUpdateServerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsCertificateStoreUpdateServerRequest{}

// CSSCMSDataModelModelsCertificateStoreUpdateServerRequest struct for CSSCMSDataModelModelsCertificateStoreUpdateServerRequest
type CSSCMSDataModelModelsCertificateStoreUpdateServerRequest struct {
	Id        int32                                   `json:"id"`
...
func NewCSSCMSDataModelModelsCertificateStoreUpdateServerRequest(id int32, username CSSCMSDataModelModelsKeyfactorAPISecret, password CSSCMSDataModelModelsKeyfactorAPISecret, useSSL bool, name string) *CSSCMSDataModelModelsCertificateStoreUpdateServerRequest {
	this := CSSCMSDataModelModelsCertificateStoreUpdateServerRequest{}
	this.Id = id
...
func (o *CSSCMSDataModelModelsCertificateStoreUpdateServerRequest) SetContainerNil() {
	o.Container.Set(nil)
}
...
func (o CSSCMSDataModelModelsCertificateStoreUpdateServerRequest) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsCertificateStoreUpdateServerRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest struct {
	value *CSSCMSDataModelModelsCertificateStoreUpdateServerRequest
	isSet bool
}

func (v NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest) Get() *CSSCMSDataModelModelsCertificateStoreUpdateServerRequest {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest) Set(val *CSSCMSDataModelModelsCertificateStoreUpdateServerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest(val *CSSCMSDataModelModelsCertificateStoreUpdateServerRequest) *NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest {
	return &NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsCertificateStoreUpdateServerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
