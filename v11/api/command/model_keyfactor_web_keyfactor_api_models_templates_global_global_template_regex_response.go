...
// checks if the KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse{}

// KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse struct for KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse
type KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse struct {
...
func NewKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse() *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse {
	this := KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) SetSubjectPartNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) SetRegexNil() {
	o.Regex.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse struct {
	value *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) Get() *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) Set(val *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse(val *KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) *NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
