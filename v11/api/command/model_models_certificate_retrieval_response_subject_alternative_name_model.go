...
func (o *ModelsCertificateRetrievalResponseSubjectAlternativeNameModel) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *ModelsCertificateRetrievalResponseSubjectAlternativeNameModel) SetValueHashNil() {
	o.ValueHash.Set(nil)
}
