...
// checks if the KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel{}

// KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel struct for KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel
type KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel struct {
...
func NewKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel() *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel {
	this := KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) SetSubjectPartNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) GetRegex() string {
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) SetRegexNil() {
	o.Regex.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) SetError(v string) {
	o.Error.Set(&v)
}

// SetErrorNil sets the value for Error to be an explicit nil
func (o *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel struct {
	value *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) Get() *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) Set(val *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel(val *KeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel {
	return &NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsTemplatesTemplateRegexRequestResponseModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
