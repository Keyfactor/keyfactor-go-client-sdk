...
// checks if the KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam{}

// KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam struct for KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam
type KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam struct {
...
func NewKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam() *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam {
	this := KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) SetDisplayNameNil() {
...
func (o KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam struct {
	value *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) Get() *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) Set(val *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam(val *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam {
	return &NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
