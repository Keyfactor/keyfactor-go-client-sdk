...
// checks if the KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy{}

// KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy struct for KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy
type KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy struct {
	Id                      int32                                                                  `json:"id"`
...
func NewKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy(id int32, name string, providerType KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderType) *KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy {
	this := KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy{}
	this.Id = id
	this.Name = name
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) SetSecuredAreaIdNil() {
...
func (o KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy struct {
	value *KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) Get() *KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) Set(val *KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy(val *KeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) *NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy {
	return &NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderUpdateRequestLegacy) UnmarshalJSON(src []byte) error {
	v.isSet = true
