...
// checks if the KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse{}

// KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse struct for KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse
type KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse struct {
...
func NewKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse() *KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse {
	this := KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) SetDisplayNameNil() {
...
func (o KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse struct {
	value *KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) Get() *KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) Set(val *KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse(val *KeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) *NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsEventHandlerRegisteredEventHandlerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
