...
func (o *ModelsSSHLogonsLogonQueryResponse) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *ModelsSSHLogonsLogonQueryResponse) SetLastLogonNil() {
	o.LastLogon.Set(nil)
}
...
func (o *ModelsSSHLogonsLogonQueryResponse) SetServerNameNil() {
...
func (o *ModelsSSHLogonsLogonQueryResponse) SetGroupNameNil() {
	o.GroupName.Set(nil)
}
