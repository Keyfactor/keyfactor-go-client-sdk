...
type CSSCMSDataModelModelsPkcs12CertificateResponse struct {
	...
	KeyStatus                 *CSSCMSDataModelEnumsPrivateKeyStatus `json:"keyStatus,omitempty"`
...
func (o *CSSCMSDataModelModelsPkcs12CertificateResponse) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *CSSCMSDataModelModelsPkcs12CertificateResponse) GetKeyStatus() CSSCMSDataModelEnumsPrivateKeyStatus {
	if o == nil || isNil(o.KeyStatus) {
		var ret CSSCMSDataModelEnumsPrivateKeyStatus
		return ret
	}
	return *o.KeyStatus
}
...
// SetKeyStatus gets a reference to the given CSSCMSDataModelEnumsPrivateKeyStatus and assigns it to the KeyStatus field.
