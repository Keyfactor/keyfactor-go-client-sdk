...
// checks if the ModelsTemplatesTemplateRegex type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsTemplatesTemplateRegex{}

// ModelsTemplatesTemplateRegex struct for ModelsTemplatesTemplateRegex
type ModelsTemplatesTemplateRegex struct {
...
func NewModelsTemplatesTemplateRegex() *ModelsTemplatesTemplateRegex {
	this := ModelsTemplatesTemplateRegex{}
	return &this
}
...
func (o *ModelsTemplatesTemplateRegex) SetSubjectPartNil() {
...
func (o *ModelsTemplatesTemplateRegex) SetRegexNil() {
	o.Regex.Set(nil)
}
...
func (o *ModelsTemplatesTemplateRegex) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o ModelsTemplatesTemplateRegex) MarshalJSON() ([]byte, error) {
...
func (o ModelsTemplatesTemplateRegex) ToMap() (map[string]interface{}, error) {
...
type NullableModelsTemplatesTemplateRegex struct {
	value *ModelsTemplatesTemplateRegex
	isSet bool
}

func (v NullableModelsTemplatesTemplateRegex) Get() *ModelsTemplatesTemplateRegex {
	return v.value
}

func (v *NullableModelsTemplatesTemplateRegex) Set(val *ModelsTemplatesTemplateRegex) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsTemplatesTemplateRegex) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsTemplatesTemplateRegex) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsTemplatesTemplateRegex(val *ModelsTemplatesTemplateRegex) *NullableModelsTemplatesTemplateRegex {
	return &NullableModelsTemplatesTemplateRegex{value: val, isSet: true}
}

func (v NullableModelsTemplatesTemplateRegex) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsTemplatesTemplateRegex) UnmarshalJSON(src []byte) error {
	v.isSet = true
