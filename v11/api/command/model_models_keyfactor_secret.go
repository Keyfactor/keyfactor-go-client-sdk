...
// checks if the ModelsKeyfactorSecret type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsKeyfactorSecret{}

// ModelsKeyfactorSecret struct for ModelsKeyfactorSecret
type ModelsKeyfactorSecret struct {
	...
	ProviderTypeParameterValues []ModelsPamProviderTypeParamValue `json:"providerTypeParameterValues,omitempty"`
...
func (o *ModelsKeyfactorSecret) SetInstanceIdNil() {
...
func (o *ModelsKeyfactorSecret) SetInstanceGuidNil() {
...
// SetProviderTypeParameterValues gets a reference to the given []ModelsPamProviderTypeParamValue and assigns it to the ProviderTypeParameterValues field.
...
func (o *ModelsKeyfactorSecret) SetProviderIdNil() {
...
func (o ModelsKeyfactorSecret) MarshalJSON() ([]byte, error) {
...
func (o ModelsKeyfactorSecret) ToMap() (map[string]interface{}, error) {
...
type NullableModelsKeyfactorSecret struct {
	value *ModelsKeyfactorSecret
	isSet bool
}

func (v NullableModelsKeyfactorSecret) Get() *ModelsKeyfactorSecret {
	return v.value
}

func (v *NullableModelsKeyfactorSecret) Set(val *ModelsKeyfactorSecret) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsKeyfactorSecret) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsKeyfactorSecret) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsKeyfactorSecret(val *ModelsKeyfactorSecret) *NullableModelsKeyfactorSecret {
	return &NullableModelsKeyfactorSecret{value: val, isSet: true}
}

func (v NullableModelsKeyfactorSecret) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsKeyfactorSecret) UnmarshalJSON(src []byte) error {
	v.isSet = true
