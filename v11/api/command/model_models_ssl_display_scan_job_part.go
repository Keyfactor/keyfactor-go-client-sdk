...
func (o *ModelsSSLDisplayScanJobPart) SetAgentNil() {
	o.Agent.Set(nil)
}
...
func (o *ModelsSSLDisplayScanJobPart) SetStartTimeNil() {
	o.StartTime.Set(nil)
}
...
func (o *ModelsSSLDisplayScanJobPart) SetEndTimeNil() {
	o.EndTime.Set(nil)
}
...
func (o *ModelsSSLDisplayScanJobPart) SetEndpointCountNil() {
