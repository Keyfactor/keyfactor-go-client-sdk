...
// checks if the KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest{}

// KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest struct for KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest
type KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest struct {
...
func NewKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest(displayName string, subject string, message string) *KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest {
	this := KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest{}
...
func (o *KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) SetTemplateIdNil() {
...
func (o KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest struct {
	value *KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) Get() *KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) Set(val *KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest(val *KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) *NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest {
	return &NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
