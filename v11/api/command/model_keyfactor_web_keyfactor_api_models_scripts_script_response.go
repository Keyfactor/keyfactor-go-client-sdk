...
// checks if the KeyfactorWebKeyfactorApiModelsScriptsScriptResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsScriptsScriptResponse{}
...
func NewKeyfactorWebKeyfactorApiModelsScriptsScriptResponse() *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse {
	this := KeyfactorWebKeyfactorApiModelsScriptsScriptResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse) SetContentsNil() {
	o.Contents.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsScriptsScriptResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsScriptsScriptResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse struct {
	value *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse) Get() *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse) Set(val *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse(val *KeyfactorWebKeyfactorApiModelsScriptsScriptResponse) *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsScriptsScriptResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
