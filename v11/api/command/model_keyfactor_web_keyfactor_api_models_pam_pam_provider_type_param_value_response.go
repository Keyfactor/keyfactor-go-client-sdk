...
// checks if the KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse{}

// KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse struct for KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse
type KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse struct {
	Id                *int32                                                          `json:"id,omitempty"`
	Value             NullableString                                                  `json:"value,omitempty"`
	InstanceId        NullableInt32                                                   `json:"instanceId,omitempty"`
	InstanceGuid      NullableString                                                  `json:"instanceGuid,omitempty"`
	ProviderTypeParam *KeyfactorWebKeyfactorApiModelsPAMProviderTypeParameterResponse `json:"providerTypeParam,omitempty"`
}
...
func NewKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse() *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse {
	this := KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) SetValueNil() {
	o.Value.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) GetInstanceIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) SetInstanceIdNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) SetInstanceGuidNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) GetProviderTypeParam() KeyfactorWebKeyfactorApiModelsPAMProviderTypeParameterResponse {
	if o == nil || isNil(o.ProviderTypeParam) {
		var ret KeyfactorWebKeyfactorApiModelsPAMProviderTypeParameterResponse
		return ret
	}
...
// SetProviderTypeParam gets a reference to the given KeyfactorWebKeyfactorApiModelsPAMProviderTypeParameterResponse and assigns it to the ProviderTypeParam field.
...
func (o KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse struct {
	value *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) Get() *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) Set(val *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse(val *KeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) *NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMPamProviderTypeParamValueResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
