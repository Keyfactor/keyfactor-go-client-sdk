...
// checks if the KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse{}

// KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse struct for KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse
type KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse struct {
...
func NewKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse() *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse {
	this := KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) SetDisplayNameNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) SetSubjectNil() {
	o.Subject.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse struct {
	value *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) Get() *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) Set(val *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse(val *KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) *NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
