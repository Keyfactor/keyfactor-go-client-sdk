...
// checks if the KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse{}

// KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse Public DTO for handling responses that include a security identity.
type KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse struct {
...
func NewKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse() *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse {
	this := KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) SetAccountNameNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) SetIdentityTypeNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) SetValidNil() {
	o.Valid.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) SetSidNil() {
	o.Sid.Set(nil)
}
...
func (o KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse struct {
	value *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) Get() *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) Set(val *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse(val *KeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse {
	return &NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsSecuritySecurityIdentitiesSecurityIdentityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
