...
// checks if the KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue{}

// KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue struct for KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue
type KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue struct {
	Id                *int32                                                                   `json:"id,omitempty"`
	Value             NullableString                                                           `json:"value,omitempty"`
	InstanceId        NullableInt32                                                            `json:"instanceId,omitempty"`
	InstanceGuid      NullableString                                                           `json:"instanceGuid,omitempty"`
	ProviderTypeParam *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam `json:"providerTypeParam,omitempty"`
}
...
func NewKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue() *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue {
	this := KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue{}
	return &this
}
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) SetInstanceIdNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) SetInstanceGuidNil() {
...
func (o *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) GetProviderTypeParam() KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam {
	if o == nil || isNil(o.ProviderTypeParam) {
		var ret KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam
		return ret
	}
...
// SetProviderTypeParam gets a reference to the given KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestProviderTypeParam and assigns it to the ProviderTypeParam field.
...
func (o KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) MarshalJSON() ([]byte, error) {
...
func (o KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) ToMap() (map[string]interface{}, error) {
...
type NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue struct {
	value *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue
	isSet bool
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) Get() *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue {
	return v.value
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) Set(val *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue(val *KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue {
	return &NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue{value: val, isSet: true}
}

func (v NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyfactorWebKeyfactorApiModelsPAMProviderCreateRequestTypeParamValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
