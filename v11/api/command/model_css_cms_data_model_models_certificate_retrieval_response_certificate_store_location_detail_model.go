...
// checks if the CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel{}

// CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel struct for CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel
type CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel struct {
...
func NewCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel() *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel {
	this := CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel{}
	return &this
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) SetStorePathNil() {
	o.StorePath.Set(nil)
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) SetAgentPoolNil() {
	o.AgentPool.Set(nil)
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) SetIpAddressNil() {
	o.IpAddress.Set(nil)
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) GetPort() int32 {
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) SetNetworkName(v string) {
	o.NetworkName.Set(&v)
}

// SetNetworkNameNil sets the value for NetworkName to be an explicit nil
func (o *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) SetNetworkNameNil() {
...
func (o CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) MarshalJSON() ([]byte, error) {
...
func (o CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) ToMap() (map[string]interface{}, error) {
...
type NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel struct {
	value *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel
	isSet bool
}

func (v NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) Get() *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) Set(val *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel(val *CSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) *NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel {
	return &NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsCertificateRetrievalResponseCertificateStoreLocationDetailModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
