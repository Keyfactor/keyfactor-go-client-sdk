...
// checks if the ModelsCertificateStoreContainerPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsCertificateStoreContainerPermissions{}

// ModelsCertificateStoreContainerPermissions struct for ModelsCertificateStoreContainerPermissions
type ModelsCertificateStoreContainerPermissions struct {
...
func NewModelsCertificateStoreContainerPermissions() *ModelsCertificateStoreContainerPermissions {
	this := ModelsCertificateStoreContainerPermissions{}
	return &this
}
...
func (o *ModelsCertificateStoreContainerPermissions) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o ModelsCertificateStoreContainerPermissions) MarshalJSON() ([]byte, error) {
...
func (o ModelsCertificateStoreContainerPermissions) ToMap() (map[string]interface{}, error) {
...
type NullableModelsCertificateStoreContainerPermissions struct {
	value *ModelsCertificateStoreContainerPermissions
	isSet bool
}

func (v NullableModelsCertificateStoreContainerPermissions) Get() *ModelsCertificateStoreContainerPermissions {
	return v.value
}

func (v *NullableModelsCertificateStoreContainerPermissions) Set(val *ModelsCertificateStoreContainerPermissions) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsCertificateStoreContainerPermissions) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsCertificateStoreContainerPermissions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsCertificateStoreContainerPermissions(val *ModelsCertificateStoreContainerPermissions) *NullableModelsCertificateStoreContainerPermissions {
	return &NullableModelsCertificateStoreContainerPermissions{value: val, isSet: true}
}

func (v NullableModelsCertificateStoreContainerPermissions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsCertificateStoreContainerPermissions) UnmarshalJSON(src []byte) error {
	v.isSet = true
