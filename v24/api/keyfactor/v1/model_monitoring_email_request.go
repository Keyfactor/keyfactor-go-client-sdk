...
// checks if the MonitoringEmailRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitoringEmailRequest{}
...
type NullableMonitoringEmailRequest struct {
	value *MonitoringEmailRequest
	isSet bool
}

func (v NullableMonitoringEmailRequest) Get() *MonitoringEmailRequest {
	return v.value
}

func (v *NullableMonitoringEmailRequest) Set(val *MonitoringEmailRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringEmailRequest) IsSet() bool {
	return v.isSet
}
...
func NewNullableMonitoringEmailRequest(val *MonitoringEmailRequest) *NullableMonitoringEmailRequest {
	return &NullableMonitoringEmailRequest{value: val, isSet: true}
}
