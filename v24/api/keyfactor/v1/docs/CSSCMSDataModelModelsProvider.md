...
**IsInUse** | Pointer to **bool** |  | [optional] [readonly] 
**IsLocalDB** | Pointer to **bool** |  | [optional] [readonly] 
...
GetIsLocalDB returns the IsLocalDB field if non-nil, zero value otherwise.

### GetIsLocalDBOk

`func (o *CSSCMSDataModelModelsProvider) GetIsLocalDBOk() (*bool, bool)`

GetIsLocalDBOk returns a tuple with the IsLocalDB field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIsLocalDB sets IsLocalDB field to given value.
