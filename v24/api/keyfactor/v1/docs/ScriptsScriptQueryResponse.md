...
`func (o *ScriptsScriptQueryResponse) SetNameNil(b bool)`
...
`func (o *ScriptsScriptQueryResponse) SetCategoriesNil(b bool)`

 SetCategoriesNil sets the value for Categories to be an explicit nil

### UnsetCategories
`func (o *ScriptsScriptQueryResponse) UnsetCategories()`
