...
// checks if the CSSCMSDataModelModelsCertificateCollectionNavItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsCertificateCollectionNavItem{}
...
func NewCSSCMSDataModelModelsCertificateCollectionNavItem() *CSSCMSDataModelModelsCertificateCollectionNavItem {
	this := CSSCMSDataModelModelsCertificateCollectionNavItem{}
	return &this
}
...
func (o *CSSCMSDataModelModelsCertificateCollectionNavItem) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o CSSCMSDataModelModelsCertificateCollectionNavItem) MarshalJSON() ([]byte, error) {
...
type NullableCSSCMSDataModelModelsCertificateCollectionNavItem struct {
	value *CSSCMSDataModelModelsCertificateCollectionNavItem
	isSet bool
}

func (v NullableCSSCMSDataModelModelsCertificateCollectionNavItem) Get() *CSSCMSDataModelModelsCertificateCollectionNavItem {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsCertificateCollectionNavItem) Set(val *CSSCMSDataModelModelsCertificateCollectionNavItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsCertificateCollectionNavItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsCertificateCollectionNavItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsCertificateCollectionNavItem(val *CSSCMSDataModelModelsCertificateCollectionNavItem) *NullableCSSCMSDataModelModelsCertificateCollectionNavItem {
	return &NullableCSSCMSDataModelModelsCertificateCollectionNavItem{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsCertificateCollectionNavItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsCertificateCollectionNavItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
