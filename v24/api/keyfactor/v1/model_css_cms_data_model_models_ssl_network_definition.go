...
// checks if the CSSCMSDataModelModelsSSLNetworkDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSSCMSDataModelModelsSSLNetworkDefinition{}
...
func (o *CSSCMSDataModelModelsSSLNetworkDefinition) GetItemType() KeyfactorOrchestratorsCommonEnumsSslNetworkDefinitionItemType {
	if o == nil || isNil(o.ItemType) {
		var ret KeyfactorOrchestratorsCommonEnumsSslNetworkDefinitionItemType
		return ret
	}
	return *o.ItemType
}
...
func (o *CSSCMSDataModelModelsSSLNetworkDefinition) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o CSSCMSDataModelModelsSSLNetworkDefinition) MarshalJSON() ([]byte, error) {
...
type NullableCSSCMSDataModelModelsSSLNetworkDefinition struct {
	value *CSSCMSDataModelModelsSSLNetworkDefinition
	isSet bool
}

func (v NullableCSSCMSDataModelModelsSSLNetworkDefinition) Get() *CSSCMSDataModelModelsSSLNetworkDefinition {
	return v.value
}

func (v *NullableCSSCMSDataModelModelsSSLNetworkDefinition) Set(val *CSSCMSDataModelModelsSSLNetworkDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableCSSCMSDataModelModelsSSLNetworkDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableCSSCMSDataModelModelsSSLNetworkDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCSSCMSDataModelModelsSSLNetworkDefinition(val *CSSCMSDataModelModelsSSLNetworkDefinition) *NullableCSSCMSDataModelModelsSSLNetworkDefinition {
	return &NullableCSSCMSDataModelModelsSSLNetworkDefinition{value: val, isSet: true}
}

func (v NullableCSSCMSDataModelModelsSSLNetworkDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCSSCMSDataModelModelsSSLNetworkDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
