...
> EnrollmentPFXEnrollmentManagementResponse NewCreateEnrollmentPFXRequest(ctx).XKeyfactorRequestedWith(xKeyfactorRequestedWith).XCertificateformat(xCertificateformat).XKeyfactorApiVersion(xKeyfactorApiVersion).EnrollmentPFXEnrollmentWithStoresRequest(enrollmentPFXEnrollmentWithStoresRequest).Execute()
