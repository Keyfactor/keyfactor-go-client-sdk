...
`func (o *ModelsQueryModelsPagedCertificateStoreQuery) GetPageReturned() int32`
...
`func (o *ModelsQueryModelsPagedCertificateStoreQuery) GetReturnLimit() int32`
...
`func (o *ModelsQueryModelsPagedCertificateStoreQuery) SetReturnLimit(v int32)`
